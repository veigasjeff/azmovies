...
import adultp1Data from '../../../public/adultp1.json'
...
const adultpage1 = ({ adultp1Item }) => {
  ...
  useEffect(() => {
    const detectMobileDevice = () => {
      ...
      const mobile = Boolean(
        userAgent.match(
          /Android|iPhone|iPad|iPod|Opera Mini|IEMobile|WPadult/i
        )
      )
  ...
  }, [adultp1Item, enableNoiseCancellation])
  ...
  const softwareSchema = JSON.stringify({
    ...
    datePublished: adultp1Item.datePublished,
    dateModified: adultp1Item.dateModified,
    softwareVersion: adultp1Item.softwareVersion,
    url: adultp1Item.siteurl,
    operatingSystem: adultp1Item.operatingSystem,
    applicationCategory: adultp1Item.applicationCategory,
    image: adultp1Item.image,
    name: adultp1Item.name,
    interactionStatistic: adultp1Item.interactionStatistic,
    offers: {
  ...
  const breadcrumbSchema = JSON.stringify({
    ...
    itemListElement: [
      ...
      },
      {
        ...
        position: 2,
        name: 'adult',
        item: adultp1Item.baseurl
      },
      {
        '@type': 'ListItem',
        position: 3,
        name: adultp1Item.name,
        item: adultp1Item.siteurl
      }
    ]
  })
  ...
  const rankMathSchema = JSON.stringify({
    ...
    '@graph': [
      ...
      {
        '@type': 'WebPage',
        '@id': `${adultp1Item.siteurl}#webpage`,
        url: adultp1Item.siteurl,
        name: `${adultp1Item.name} | A to Z Movies`,
        datePublished: adultp1Item.datePublished,
        dateModified: adultp1Item.dateModified,
        isPartOf: {
          '@id': 'https://azmovies.vercel.app#website'
      ...
      {
        '@type': 'Article',
        '@id': `${adultp1Item.siteurl}#article`,
        headline: `Download ${adultp1Item.name} | A to Z Movies`,
        datePublished: adultp1Item.datePublished,
        dateModified: adultp1Item.dateModified,
        articleSection: 'adult',
        author: {
          '@id': 'https://azmovies.vercel.appauthor/adultp1Item/'
        },
        publisher: {
          '@id': 'https://gravatar.com/drtrailer2022/#person'
        },
        description: adultp1Item.synopsis,
        image: adultp1Item.image,
        name: `Download ${adultp1Item.name} | A to Z Movies`,
        isPartOf: {
          '@id': `${adultp1Item.siteurl}#webpage`
        },
        inLanguage: 'en-US',
      ...
      {
        '@type': 'BlogPosting',
        '@id': `${adultp1Item.siteurl}#blogPost`,
        headline: `Download ${adultp1Item.name} | A to Z Movies`,
        datePublished: adultp1Item.datePublished,
        dateModified: adultp1Item.dateModified,
        articleSection: 'adult',
        ...
        image: adultp1Item.image,
        name: `Download ${adultp1Item.name} | A to Z Movies`,
        '@id': `${adultp1Item.siteurl}#richSnippet`,
        isPartOf: {
          '@id': `${adultp1Item.siteurl}#webpage`
        },
        inLanguage: 'en-US',
  ...
  const newsArticleSchema = {
    '@context': 'https://schema.org',
    '@type': 'NewsArticle',
    '@id': `${adultp1Item.siteurl}#webpage`, // Add a comma here
    name: adultp1Item.title,
    url: adultp1Item.siteurl,
    description: adultp1Item.synopsis,
    image: adultp1Item.image,
    datePublished: adultp1Item.startDate,
    potentialAction: {
      '@type': 'WatchAction',
      target: {
        '@type': 'EntryPoint',
        name: adultp1Item.title,
        urlTemplate: adultp1Item.siteurl
      }
    },
    locationCreated: {
      '@type': 'Place',
      name: adultp1Item.country
    },
    author: {
      '@type': 'Person',
      name: 'DrTrailer',
    ...
    additionalProperty: {
      ...
      value: ['adult Web Platform', 'iOS Platform', 'Android Platform']
    }
  }
  ...
  return (
    <div>
      <Head>
        ...
        />
        <title> Download {adultp1Item && adultp1Item.name} | A to Z Movies</title>
        <link rel='canonical' href={adultp1Item && adultp1Item.siteurl} />
        ...
        <meta
          property='og:title'
          content={`${adultp1Item && adultp1Item.name} - A to Z Movies`}
        />
        <meta
        ...
        <meta property='og:url' content={`${adultp1Item && adultp1Item.siteurl}`} />
        <meta name='keywords' content={`${adultp1Item && adultp1Item.keywords}`} />
        <meta property='og:site_name' content='A to Z Movies' />
        <meta property='og:type' content='article' />
        <meta
          property=' og:image:alt'
          content={`${adultp1Item && adultp1Item.group}`}
        />
        ...
        <meta
          property='og:image'
          content={`${adultp1Item && adultp1Item.backimage}`}
        />
      ...
      >
        ...
        <div className='flex-container'>
          <div className='category-container'>
            <Image
              src={adultp1Item.channelposter}
              alt={adultp1Item.title}
              width={300}
              height={300}
              quality={90}
              objectFit='cover'
            ...
            >
              ...
              <p className='text-black text-bg font-semibold mt-2'>
                Version: {adultp1Item.version}
              </p>
              <p className='text-black text-bg font-semibold mt-2'>
                Developers: {adultp1Item.developers}
              </p>
              <p className='text-black text-bg font-semibold mt-2'>
                License: {adultp1Item.license}
              </p>
              <h2 className='text-black font-bold mt-2 text-sm mb-2 items-center justify-center '>
              {' '}
              Author: {adultp1Item.group}.
            </h2>
             <Image
                src={adultp1Item.directorimg}
                alt={adultp1Item.group}
                width={100}
                height={100}
                quality={90}
                objectFit='cover'
          ...
          */}
                    ...
                    {seconds === 0 && (
                      <>
                        {adultp1Item.downloadlink && (
                          <Link href={adultp1Item.downloadlink} target='_blank'>
                            <div
                        ...
                        {adultp1Item.downloadlink1 && (
                          <Link href={adultp1Item.downloadlink1} target='_blank'>
                            <div
                              className='bg-gradient-to-r from-amber-500 to-pink-500 text-white font-bold py-3 px-6 rounded-lg shadow-lg hover:from-amber-600 hover:to-pink-600 transition duration-300'
                              style={{
                                margin: 'auto',
                        ...
                        {adultp1Item.additionalLinks?.map((link, index) => (
              ...
              <div className='flex flex-col items-center justify-center'>
                <p className='bg-gradient-to-r from-amber-500 to-pink-500 font-bold py-3 px-6 rounded-lg shadow-lg hover:from-amber-600 hover:to-pink-600 transition duration-300  text-bg text-black text-bg  mt-2 text-3xl mb-2 items-center justify-center '>
                  <strong> {adultp1Item.head1} </strong>
                </p>
              </div>
              <Image
                src={adultp1Item.image1}
                alt={adultp1Item.name}
                width={1280}
                height={720}
                quality={90}
                objectFit='cover'
              ...
              <div className='flex flex-col items-center justify-center'>
                <p className='bg-gradient-to-r from-amber-500 to-pink-500 font-bold py-3 px-6 rounded-lg shadow-lg hover:from-amber-600 hover:to-pink-600 transition duration-300  text-bg text-black text-bg  mt-2 text-3xl mb-2 items-center justify-center '>
                  <strong> {adultp1Item.head2} </strong>
                </p>
              </div>
              <Image
                src={adultp1Item.image2}
                alt={adultp1Item.name}
                width={1280}
                height={720}
                quality={90}
              ...
              <div className='flex flex-col items-center justify-center'>
                <p className='bg-gradient-to-r from-amber-500 to-pink-500 font-bold py-3 px-6 rounded-lg shadow-lg hover:from-amber-600 hover:to-pink-600 transition duration-300  text-bg text-black text-bg  mt-2 text-3xl mb-2 items-center justify-center '>
                  <strong> {adultp1Item.head3} </strong>
                </p>
              </div>
              <Image
                src={adultp1Item.image3}
                alt={adultp1Item.name}
                width={1280}
                height={720}
                quality={90}
              ...
              <div className='flex flex-col items-center justify-center'>
                <p className='bg-gradient-to-r from-amber-500 to-pink-500 font-bold py-3 px-6 rounded-lg shadow-lg hover:from-amber-600 hover:to-pink-600 transition duration-300  text-bg text-black text-bg  mt-2 text-3xl mb-2 items-center justify-center '>
                  <strong> {adultp1Item.head4} </strong>
                </p>
              </div>
              {adultp1Item.news4.split('\n\n').map((paragraph, idx) => (
                <p
                  key={idx}
                  className='description text-black font-bold mt-2 text-xl'
                  style={{
...
export async function getStaticPaths () {
  const paths = adultp1Data.map(item => ({
    params: { id: item.id }
  }))
...
export async function getStaticProps ({ params }) {
  const adultp1Item = adultp1Data.find(item => item.id === params.id)
  return { props: { adultp1Item } }
}
export default adultpage1
