  ...
  const rankMathSchema = JSON.stringify({
    ...
    '@graph': [
      ...
      },
      {
        ...
        headline: ` ${adultzipItem.name} | AtoZ™`,
        datePublished: adultzipItem.datePublished,
        dateModified: adultzipItem.dateModified,
  ...
  return (
    <div>
      <Head>
        ...
        />
        <title> {adultzipItem.name} | AtoZ™</title>
        ...
        <meta
          property='og:title'
          content={`${adultzipItem && adultzipItem.name} - AtoZ™`}
        />
        <meta
          property='og:description'
          content='Stream HD adultzipItems and TV series for free on AtoZ™. Online. Stream. Download. full-length adultzipItems and shows in HD quality without registration.'
        />
        <meta
          name='description'
          content={`${adultzipItem.title} available on AtoZ™. Enjoy free streaming of full-length adultzipItems and TV series online with no registration required.`}
        />
        <meta
          property='og:url'
        ...
        <meta
          name='twitter:title'
          content='AtoZ™ - Explore. Discover. Online.'
        />
        <meta
      ...
      >
        ...
        {isAdult && (
          <>
            ...
            <p className='text-lg text-yellow-500 mt-4'>
              ...
              <strong>AtoZ™</strong>, we offer a vast library of premium
            ...
            <p className='text-lg text-yellow-500 mt-4'>
              Streaming <strong>{adultzipItem.title}</strong> on{' '}
              <strong>AtoZ™</strong> provides you with a user-friendly
              ...
              <strong>{adultzipItem.title}</strong>
        ...
        {!isTVShow && !isAdult && (
          <>
            ...
            <p className='text-lg text-yellow-500 mt-4'>
              Streaming <strong>{adultzipItem.title}</strong> on{' '}
              <strong>AtoZ™</strong> guarantees a seamless viewing
            ...
            <p className='text-lg text-yellow-500 mt-4'>
              ...
              <strong>{adultzipItem.title}</strong> on{' '}
              <strong>AtoZ™</strong> is the perfect way to enjoy your
              ...
              <strong>AtoZ™</strong>, your entertainment is just a click
              away.
            </p>
          </>
        )}
