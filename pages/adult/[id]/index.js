  ...
  />
     ...
     <Script src='../../propler/ads.js' defer />
      ...
      <a
          ...
          >
            <p style={{ display: 'inline-block' }} className=' title text-2xl font-bold'>
...
{/* <main style={{ width: '100%', display: 'block' }}>
        ...
        <div className="actors">
          <h2 className='px-0 bg-gradient-to-r from-amber-500 to-pink-500 bg-clip-text text-transparent text-4xl hover:text-blue-800 font-bold mt-2'>Cast</h2>
