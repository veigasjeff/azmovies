...
import adultsData from '../../../public/adultfull.json'
...
const adultDetail = ({ adult }) => {
  ...
  // Determine the type of content (adult, tvshow, or adult)
  const isTVShow = adult.type === 'tvshow'
  ...
  const rankMathSchema = JSON.stringify({
    ...
    '@graph': [
      ...
      },
      {
        ...
        headline: `${adult.name} | AtoZ Movies™`,
        datePublished: adult.datePublished,
        dateModified: adult.dateModified,
        articleSection: 'adults',
        author: {
          '@id': 'https://gravatar.com/drtrailer2022/'
        },
        publisher: {
  ...
  return (
    <div>
      <Head>
        ...
        <meta property='og:title' content={`${adult && adult.name} - AtoZ™`} />
        <meta
      ...
      {isAdult && <AdultSkipAds adultzipItem={adult} />}
        ...
        {isTVShow && (
          <>
            ...
            <p className='text-lg bg-gradient-to-r from-pink-700 to-blue-700 bg-clip-text text-transparent mt-4'>
              ...
              <strong> AtoZ </strong>, you can stream{' '}
            ...
            <p className='text-lg bg-gradient-to-r from-pink-700 to-blue-700 bg-clip-text text-transparent mt-4'>
              Streaming <strong>{adult.title}</strong> on <strong>AtoZ </strong>{' '}
              ensures that you won't miss a single moment of the action, drama,
              or comedy that makes this TV series a must-watch. With
              high-quality streaming and user-friendly navigation,{' '}
              <strong>AtoZ </strong> provides everything you need to enjoy{' '}
              <strong>{adult.title}</strong>
            ...
            <p className='text-lg bg-gradient-to-r from-pink-700 to-blue-700 bg-clip-text text-transparent mt-4'>
              ...
              <strong>{adult.title}</strong> on <strong>AtoZ </strong> is your
              go-to destination for streaming TV series online. Join our
              community of viewers and start watching{' '}
              <strong>{adult.title}</strong> today. With <strong>AtoZ </strong>,
              your favorite TV series is just a click away.
            </p>
          </>
        )}
        ...
        {isAdult && (
          <>
            ...
            <p className='text-lg bg-gradient-to-r from-pink-700 to-blue-700 bg-clip-text text-transparent mt-4'>
              ...
              <strong>{adult.title}</strong>. At <strong>AtoZ </strong>, we
              offer a vast library of premium adult content, including the
              latest and most popular titles like <strong>{adult.title}</strong>
            ...
            <p className='text-lg bg-gradient-to-r from-pink-700 to-blue-700 bg-clip-text text-transparent mt-4'>
              Streaming <strong>{adult.title}</strong> on <strong>AtoZ </strong>{' '}
              provides you with a user-friendly interface and crystal-clear
              video quality. Our adult content is regularly updated, giving you
              access to new releases as soon as they become available. Whether
              you're exploring new genres or returning to your favorites,{' '}
              <strong>{adult.title}</strong>
              and other top titles are available at your fingertips.
            </p>
            <p className='text-lg bg-gradient-to-r from-pink-700 to-blue-700 bg-clip-text text-transparent mt-4'>
              For a premium experience in adult entertainment, look no further
              than <strong>{adult.title}</strong> on <strong>AtoZ </strong>. Our
              platform ensures your privacy and security while you enjoy the
              content you love. Start streaming <strong>{adult.title}</strong>{' '}
              today and discover why <strong>AtoZ </strong> is the trusted
        ...
        {!isTVShow && !isAdult && (
          <>
            ...
            <p className='text-lg bg-gradient-to-r from-pink-700 to-blue-700 bg-clip-text text-transparent mt-4'>
              ...
              available to stream right here. At <strong>AtoZ </strong>, we
              bring you the best in entertainment, offering an extensive library
              of adults and TV shows, including the latest blockbusters like{' '}
              <strong>{adult.title}</strong>. Whether you're a fan of action,
              drama, comedy, or any other genre, you'll find exactly what you're
              looking for.
            </p>
            <p className='text-lg bg-gradient-to-r from-pink-700 to-blue-700 bg-clip-text text-transparent mt-4'>
              Streaming <strong>{adult.title}</strong> on <strong>AtoZ </strong>{' '}
              guarantees a seamless viewing experience with high-definition
              quality and uninterrupted playback. Our platform is designed to
              make it easy for you to discover and enjoy your favorite films.
              With regularly updated content, you will always have access to the
              newest releases, ensuring you can watch{' '}
              <strong>{adult.title}</strong> and other top titles as soon as
              they're available.
            </p>
            <p className='text-lg bg-gradient-to-r from-pink-700 to-blue-700 bg-clip-text text-transparent mt-4'>
              Whether you're revisiting a classic or catching a new release,{' '}
              <strong>{adult.title}</strong> on <strong>AtoZ </strong> is the
              perfect way to enjoy your adult night. Join the countless users
              who trust us for their streaming needs and start watching{' '}
              <strong>{adult.title}</strong> online today. At{' '}
              <strong>AtoZ </strong>, your entertainment is just a click away.
            </p>
          </>
        )}
        <a
                  ...
                  <div className={styles.iframeWrapper}>
                    <div className={styles.iframeContainer}>
                      <iframe
                        ...
                        frameBorder='0'
                        src={`https://geo.dailymotion.com/player/xjrxe.html?video=${adult.traileritem}&mute=true&Autoquality=1080p`}
                        allowFullScreen
