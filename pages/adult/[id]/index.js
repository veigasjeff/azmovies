...
export async function getStaticProps({ params }) {
  try {
    ...
    console.log('Fetched TV show item:', adultItem); // Logging the fetched TV show item for verification

    return { props: { adultItem } };
  } catch (error) {
    console.error('Error fetching TV show item:', error.message);
    return { props: { adultItem: null, error: error.message } };
  }
}
  ...
  const rankMathSchema = JSON.stringify({
    ...
    '@graph': [
      ...
      },
      {
        ...
        articleSection: 'adult',
        author: {
          '@id': 'https://azmovies.vercel.app/author/azadult/'
        },
        publisher: {
          '@id': 'https://gravatar.com/drtrailer2022/#person'
        },
  ...
  return (
    <div>
      <Head>
        ...
        />
        <title> Watch {adultItem && adultItem.name} | A to Z adult™</title>
