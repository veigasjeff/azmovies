...
const uwatchfreeSchema = JSON.stringify([
  {
    ...
    '@type': 'Organization',
    name: 'A to Z Adult™ - Explore. Discover. Download.',
...
const softwareSchema = JSON.stringify({
  ...
  headline: 'Watch Online adult | A to Z Adult™',
  url: 'https://azmovies.vercel.app/adult/',
  description:
    'Welcome to A to Z Adult™ – your go-to spot for free online adult! Watch and enjoy HD streaming, and catch the latest adults. Dive into cinema with A to Z Adult™!',
