...
const softwareSchema = JSON.stringify({
  ...
  headline: 'Watch Adult Movies | AtoZ ™',
...
const breadcrumbSchema = JSON.stringify({
  ...
  itemListElement: [
    ...
    },
    {
      ...
      position: 2,
      name: 'Adult',
      item: 'https://atozmovies.vercel.app/adult'
    }
  ]
})
...
const moviesPage = ({ items }) => {
  ...
  return (
    <div className='w-full' style={{ backgroundColor: '#D3D3D3' }}>
      <Head>
        <title> Watch Adult Movies | AtoZ ™</title>
        ...
        <meta property='og:title' content=' Watch Adult Movies | AtoZ ™' />
        <meta
