...
const uwatchfreeSchema = JSON.stringify([
  {
    ...
    '@type': 'Organization',
    name: 'AZ Adult™ - Explore. Discover. Download.',
...
const softwareSchema = JSON.stringify({
  ...
  headline: 'Watch Online Adult | AZ Adult™',
  url: 'https://azmovies.vercel.app/adult/',
  description:
    'Welcome to AZ Adult™ – your go-to spot for free online adult! Watch and enjoy HD streaming, and catch the latest adults. Dive into cinema with AZ Adult™!',
...
const adultPage = ({ items }) => {
  ...
  return (
    <div className='w-full' style={{ backgroundColor: '#D3D3D3' }}>
      <Head>
        <title> Watch Online Adult Content | AZ Adult™</title>
        ...
        <meta property='og:title' content=' Watch Online Adult |  AZ Adult™' />
        <meta
          property='og:description'
          content='Welcome to AZ Adult™ – your go-to spot for free online adult! Watch and enjoy HD streaming, and catch the latest adults. Dive into cinema with AZ Adult™!'
        />
        ...
        <meta
          name='keywords'
          content='azadult, AZ adult, a-z adult, az adult, watch free adult, watch adult online, download adult, watch full adult, watch hd adult'
        />
        <meta
          property='og:image'
          content='https://azmovies.vercel.app/og_image.jpg'
