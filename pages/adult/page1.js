...
const uwatchfreeSchema = JSON.stringify([
  {
    ...
    '@type': 'Organization',
    name: 'A to Z Adult™ - Explore. Discover. Watch.',
...
const softwareSchema = JSON.stringify({
  ...
  headline: 'A to Z Adult™ - Explore. Discover. Watch.',
...
const adultp1Page = ({ items }) => {
  ...
  return (
    <div className='w-full' style={{ backgroundColor: '#D3D3D3' }}>
     <Head>
        <title> AZ Adult™ - Adult Section.</title>
        <link
          rel='canonical'
          href='https://azmovies.vercel.app/page1/'
        />
        <meta
          name='robots'
        ...
        <meta
          property='og:url'
          content='https://azmovies.vercel.app/page1'
        />
        ...
        <meta
          name='keywords'
          content='A to Z Adult, a to z adult, a-z adult, az adult, watch free adult, watch adult online, download adult, watch full adult, watch hd adult'
        />
        <meta
          property='og:image'
      ...
      <div className='container'>
        {/* <h1  className='px-0 font-black bg-gradient-to-r from-amber-500 to-pink-500 bg-clip-text text-transparent'>adultp1 Section</h1> */}
        <div className='flex-container'>
          <div className='main-content'>
            <div className='card-container'>
              {adultp1Data.map(item => (
                <div key={item.id}>
                  {/* <div key={item.id} className='card'> */}
                  <Link href={`/adult-page1/${item.id}`}>
...
export async function getStaticProps () {
  try {
    const res = await fetch('https://azmovies.vercel.app/adultp1.json')
