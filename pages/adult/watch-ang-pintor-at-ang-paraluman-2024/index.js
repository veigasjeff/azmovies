...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    name: 'Watch Movie Ang Pintor At Ang Paraluman (2024) | AtoZ Movies™',
    alternateName: [
      'Ver película Ang Pintor At Ang Paraluman (2024) | AtoZ Movies™',
      'Regarder le film Ang Pintor At Ang Paraluman (2024) | AtoZ Movies™',
      'Film Ang Pintor At Ang Paraluman (2024) ansehen | AtoZ Movies™',
      '观看电影 Ang Pintor At Ang Paraluman (2024) | AtoZ Movies™',
      '映画 Ang Pintor At Ang Paraluman (2024) を見る | AtoZ Movies™',
      '영화 Ang Pintor At Ang Paraluman (2024) 보기 | AtoZ Movies™',
      'Assistir Filme Ang Pintor At Ang Paraluman (2024) | AtoZ Movies™',
      'Guarda il film Ang Pintor At Ang Paraluman (2024) | AtoZ Movies™',
      'Посмотреть фильм Ang Pintor At Ang Paraluman (2024) | AtoZ Movies™',
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie Ang Pintor At Ang Paraluman (2024) | AtoZ Movies™</title>
