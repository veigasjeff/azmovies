...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    name: 'Watch Movie Anokhi Part 2 (2024) | AtoZ Movies™',
    alternateName: [
      'Ver película Anokhi Part 2 (2024) | AtoZ Movies™',
      'Regarder le film Anokhi Part 2 (2024) | AtoZ Movies™',
      'Film Anokhi Part 2 (2024) ansehen | AtoZ Movies™',
      '观看电影 Anokhi Part 2 (2024) | AtoZ Movies™',
      '映画 Anokhi Part 2 (2024) を見る | AtoZ Movies™',
      '영화 Anokhi Part 2 (2024) 보기 | AtoZ Movies™',
      'Assistir Filme Anokhi Part 2 (2024) | AtoZ Movies™',
      'Guarda il film Anokhi Part 2 (2024) | AtoZ Movies™',
      'Посмотреть фильм Anokhi Part 2 (2024) | AtoZ Movies™',
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie Anokhi Part 2 (2024) | AtoZ Movies™</title>
