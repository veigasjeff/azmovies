...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    name: 'Watch Movie Daddysitter (2024) | AtoZ Movies™',
    alternateName: [
      'Ver película Daddysitter (2024) | AtoZ Movies™',
      'Regarder le film Daddysitter (2024) | AtoZ Movies™',
      'Film Daddysitter (2024) ansehen | AtoZ Movies™',
      '观看电影 Daddysitter (2024) | AtoZ Movies™',
      '映画 Daddysitter (2024) を見る | AtoZ Movies™',
      '영화 Daddysitter (2024) 보기 | AtoZ Movies™',
      'Assistir Filme Daddysitter (2024) | AtoZ Movies™',
      'Guarda il film Daddysitter (2024) | AtoZ Movies™',
      'Посмотреть фильм Daddysitter (2024) | AtoZ Movies™',
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie Daddysitter (2024) | AtoZ Movies™</title>
