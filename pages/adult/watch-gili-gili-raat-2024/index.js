...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    name: 'Watch Movie Gili Gili Raat (2024) | AtoZ Movies™',
    alternateName: [
      'Ver película Gili Gili Raat (2024) | AtoZ Movies™',
      'Regarder le film Gili Gili Raat (2024) | AtoZ Movies™',
      'Film Gili Gili Raat (2024) ansehen | AtoZ Movies™',
      '观看电影 Gili Gili Raat (2024) | AtoZ Movies™',
      '映画 Gili Gili Raat (2024) を見る | AtoZ Movies™',
      '영화 Gili Gili Raat (2024) 보기 | AtoZ Movies™',
      'Assistir Filme Gili Gili Raat (2024) | AtoZ Movies™',
      'Guarda il film Gili Gili Raat (2024) | AtoZ Movies™',
      'Посмотреть фильм Gili Gili Raat (2024) | AtoZ Movies™',
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie Gili Gili Raat (2024) | AtoZ Movies™</title>
