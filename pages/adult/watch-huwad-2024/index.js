...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    name: 'Watch Movie Huwad (2024) | AtoZ Movies™',
    alternateName: [
      'Ver película Huwad (2024) | AtoZ Movies™',
      'Regarder le film Huwad (2024) | AtoZ Movies™',
      'Film Huwad (2024) ansehen | AtoZ Movies™',
      '观看电影 Huwad (2024) | AtoZ Movies™',
      '映画 Huwad (2024) を見る | AtoZ Movies™',
      '영화 Huwad (2024) 보기 | AtoZ Movies™',
      'Assistir Filme Huwad (2024) | AtoZ Movies™',
      'Guarda il film Huwad (2024) | AtoZ Movies™',
      'Посмотреть фильм Huwad (2024) | AtoZ Movies™',
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie Huwad (2024) | AtoZ Movies™</title>
