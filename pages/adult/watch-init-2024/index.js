...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    name: 'Watch Movie Init (2024) | AtoZ Movies™',
    alternateName: [
      'Ver película Init (2024) | AtoZ Movies™',
      'Regarder le film Init (2024) | AtoZ Movies™',
      'Film Init (2024) ansehen | AtoZ Movies™',
      '观看电影 Init (2024) | AtoZ Movies™',
      '映画 Init (2024) を見る | AtoZ Movies™',
      '영화 Init (2024) 보기 | AtoZ Movies™',
      'Assistir Filme Init (2024) | AtoZ Movies™',
      'Guarda il film Init (2024) | AtoZ Movies™',
      'Посмотреть фильм Init (2024) | AtoZ Movies™',
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie Init (2024) | AtoZ Movies™</title>
