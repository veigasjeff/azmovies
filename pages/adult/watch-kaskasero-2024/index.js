...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    name: 'Watch Movie Kaskasero (2024) | AtoZ Movies™',
    alternateName: [
      'Ver película Kaskasero (2024) | AtoZ Movies™',
      'Regarder le film Kaskasero (2024) | AtoZ Movies™',
      'Film Kaskasero (2024) ansehen | AtoZ Movies™',
      '观看电影 Kaskasero (2024) | AtoZ Movies™',
      '映画 Kaskasero (2024) を見る | AtoZ Movies™',
      '영화 Kaskasero (2024) 보기 | AtoZ Movies™',
      'Assistir Filme Kaskasero (2024) | AtoZ Movies™',
      'Guarda il film Kaskasero (2024) | AtoZ Movies™',
      'Посмотреть фильм Kaskasero (2024) | AtoZ Movies™',
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie Kaskasero (2024) | AtoZ Movies™</title>
