...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    name: 'Watch Movie Kaulayaw (2024) | AtoZ Movies™',
    alternateName: [
      'Ver película Kaulayaw (2024) | AtoZ Movies™',
      'Regarder le film Kaulayaw (2024) | AtoZ Movies™',
      'Film Kaulayaw (2024) ansehen | AtoZ Movies™',
      '观看电影 Kaulayaw (2024) | AtoZ Movies™',
      '映画 Kaulayaw (2024) を見る | AtoZ Movies™',
      '영화 Kaulayaw (2024) 보기 | AtoZ Movies™',
      'Assistir Filme Kaulayaw (2024) | AtoZ Movies™',
      'Guarda il film Kaulayaw (2024) | AtoZ Movies™',
      'Посмотреть фильм Kaulayaw (2024) | AtoZ Movies™',
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie Kaulayaw (2024) | AtoZ Movies™</title>
