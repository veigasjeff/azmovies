...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    name: 'Watch Movie Lag Gayi Lottery (2024) | AtoZ Movies™',
    alternateName: [
      'Ver película Lag Gayi Lottery (2024) | AtoZ Movies™',
      'Regarder le film Lag Gayi Lottery (2024) | AtoZ Movies™',
      'Film Lag Gayi Lottery (2024) ansehen | AtoZ Movies™',
      '观看电影 Lag Gayi Lottery (2024) | AtoZ Movies™',
      '映画 Lag Gayi Lottery (2024) を見る | AtoZ Movies™',
      '영화 Lag Gayi Lottery (2024) 보기 | AtoZ Movies™',
      'Assistir Filme Lag Gayi Lottery (2024) | AtoZ Movies™',
      'Guarda il film Lag Gayi Lottery (2024) | AtoZ Movies™',
      'Посмотреть фильм Lag Gayi Lottery (2024) | AtoZ Movies™',
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie Lag Gayi Lottery (2024) | AtoZ Movies™</title>
