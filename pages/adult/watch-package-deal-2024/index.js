...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    name: 'Watch Movie Package Deal (2024) | AtoZ Movies™',
    alternateName: [
      'Ver película Package Deal (2024) | AtoZ Movies™',
      'Regarder le film Package Deal (2024) | AtoZ Movies™',
      'Film Package Deal (2024) ansehen | AtoZ Movies™',
      '观看电影 Package Deal (2024) | AtoZ Movies™',
      '映画 Package Deal (2024) を見る | AtoZ Movies™',
      '영화 Package Deal (2024) 보기 | AtoZ Movies™',
      'Assistir Filme Package Deal (2024) | AtoZ Movies™',
      'Guarda il film Package Deal (2024) | AtoZ Movies™',
      'Посмотреть фильм Package Deal (2024) | AtoZ Movies™',
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie Package Deal (2024) | AtoZ Movies™</title>
