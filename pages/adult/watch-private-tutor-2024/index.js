...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    name: 'Watch Movie Private Tutor (2024) | AtoZ Movies™',
    alternateName: [
      'Ver película Private Tutor (2024) | AtoZ Movies™',
      'Regarder le film Private Tutor (2024) | AtoZ Movies™',
      'Film Private Tutor (2024) ansehen | AtoZ Movies™',
      '观看电影 Private Tutor (2024) | AtoZ Movies™',
      '映画 Private Tutor (2024) を見る | AtoZ Movies™',
      '영화 Private Tutor (2024) 보기 | AtoZ Movies™',
      'Assistir Filme Private Tutor (2024) | AtoZ Movies™',
      'Guarda il film Private Tutor (2024) | AtoZ Movies™',
      'Посмотреть фильм Private Tutor (2024) | AtoZ Movies™',
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie Private Tutor (2024) | AtoZ Movies™</title>
