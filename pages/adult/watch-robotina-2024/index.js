...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    name: 'Watch Movie Robotina (2024) | AtoZ Movies™',
    alternateName: [
      'Ver película Robotina (2024) | AtoZ Movies™',
      'Regarder le film Robotina (2024) | AtoZ Movies™',
      'Film Robotina (2024) ansehen | AtoZ Movies™',
      '观看电影 Robotina (2024) | AtoZ Movies™',
      '映画 Robotina (2024) を見る | AtoZ Movies™',
      '영화 Robotina (2024) 보기 | AtoZ Movies™',
      'Assistir Filme Robotina (2024) | AtoZ Movies™',
      'Guarda il film Robotina (2024) | AtoZ Movies™',
      'Посмотреть фильм Robotina (2024) | AtoZ Movies™',
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie Robotina (2024) | AtoZ Movies™</title>
