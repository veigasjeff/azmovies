...
const softwareSchema = JSON.stringify({
  '@context': 'https://schema.org',
  '@type': 'Article',
  '@id': 'https://atozmovies.vercel.app/home/',
  headline: 'Movies Section | AtoZ Movies™',
  url: 'https://atozmovies.vercel.app/home/',
  description:
...
const breadcrumbSchema = JSON.stringify({
  ...
  itemListElement: [
    ...
    },
    {
      ...
      position: 2,
      name: 'movies',
      item: 'https://atozmovies.vercel.app/home/'
    }
  ]
})
...
const moviesPage = ({ items }) => {
  ...
  return (
    ...
    <div className='w-full' style={{ backgroundColor: '#000' }}>
      <Head>
        <title> Main Section | AtoZ Movies™</title>
        ...
        <meta property='og:title' content=' Main Section | AtoZ Movies™' />
        <meta
        ...
        <meta property='og:url' content='https://atozmovies.vercel.app/home' />
...
//   try {
//     const res = await fetch('https://atozmovies.vercel.app/home.json')
