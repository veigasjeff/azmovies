...
const HomePage = ({ categorizedItems }) => {
  ...
  const totalPages = Math.ceil(categorizedItems[currentCategory]?.length / itemsPerPage);

  return (
    <>
    <Head>
    <title>AtoZ Movies™ - Home Page.</title>
    <meta name="description" content="Watch and download movies, TV shows, and adult content online for free. Join the AtoZ Movies™ community now!" />
    <meta name="robots" content="index, follow" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0" />
    <link rel="canonical" href="https://atozmovies.vercel.app/home" />
    <link rel="icon" href="/favicon.ico" />
    <link rel="alternate" href="https://atozmovies.vercel.app/home" hreflang="en-us" />
    <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: freeSchema }} />
