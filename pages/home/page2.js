...
const page2 = ({ items }) => {
  ...
  const softwareSchema = JSON.stringify({
    '@context': 'https://schema.org',
    '@type': 'Article',
    '@id': 'https://atozmovies.vercel.app/home/page2',
    headline: 'Page 2 | Justwatch™',
    url: 'https://atozmovies.vercel.app/home/page2',
    description:
  ...
  const breadcrumbSchema = JSON.stringify({
    ...
    itemListElement: [
      ...
      },
      {
        ...
        position: 2,
        name: 'movies',
        item: 'https://atozmovies.vercel.app/home/page2'
      }
    ]
  })
  ...
  return (
    <div className='w-full' style={{ backgroundColor: '#000' }}>
      <Head>
        ...
        <link rel='canonical' href='https://atozmovies.vercel.app/home/page2' />
        <meta
          name='robots'
        ...
        <meta property='og:url' content='https://atozmovies.vercel.app/home/page2' />
