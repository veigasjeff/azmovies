...
const page5 = ({ items }) => {
  ...
  const softwareSchema = JSON.stringify({
    '@context': 'https://schema.org',
    '@type': 'Article',
    '@id': 'https://atozmovies.vercel.app/home/page5',
    headline: 'Page 5 | Justwatch™',
    url: 'https://atozmovies.vercel.app/home/page5',
    description:
  ...
  const breadcrumbSchema = JSON.stringify({
    ...
    itemListElement: [
      ...
      },
      {
        ...
        position: 2,
        name: 'movies',
        item: 'https://atozmovies.vercel.app/home/page5'
      }
    ]
  })
  ...
  return (
    <div className='w-full' style={{ backgroundColor: '#000' }}>
      <Head>
        <title> Page 5 | Justwatch™</title>
        <link rel='canonical' href='https://atozmovies.vercel.app/home/page5' />
        <meta
          name='robots'
        ...
        <meta property='og:title' content=' Page 5 | Justwatch™' />
        <meta
        ...
        <meta property='og:url' content='https://atozmovies.vercel.app/home/page5' />
