...
const softwareSchema = JSON.stringify({
  ...
  headline: 'Watch Movies Page 5 | AtoZ ™',
  ...
  mainEntityOfPage: {
    '@type': 'WebPage',
    '@id': 'https://atozmovies.vercel.app/home/pge5'
  },
  additionalProperty: {
    '@type': 'PropertyValue',
...
const Page5 = ({ items }) => {
  ...
  return (
    <div className='w-full' style={{ backgroundColor: '#D3D3D3' }}>
      <Head>
        <title> Watch Movies page 5 | AtoZ ™</title>
        ...
        <meta property='og:title' content=' Watch Movies page 5 | AtoZ ™' />
        <meta
