...
const softwareSchema = JSON.stringify({
  '@context': 'https://schema.org',
  '@type': 'Article',
  '@id': 'https://atozmovies.vercel.app/page6',
  headline: 'Main Section 6 | AtoZ Movies™',
  url: 'https://atozmovies.vercel.app/page6',
  description:
...
const breadcrumbSchema = JSON.stringify({
  ...
  itemListElement: [
    ...
    },
    {
      ...
      position: 2,
      name: 'movies',
      item: 'https://atozmovies.vercel.app/page6'
    }
  ]
})
...
const page6 = ({ items }) => {
  ...
  return (
    ...
    <div className='w-full' style={{ backgroundColor: '#000' }}>
      <Head>
        <title> Main Section 6 | AtoZ Movies™</title>
        <link rel='canonical' href='https://atozmovies.vercel.app/page6' />
        <meta
          name='robots'
        ...
        <meta property='og:title' content=' Main Section 6 | AtoZ Movies™' />
        <meta
        ...
        <meta property='og:url' content='https://atozmovies.vercel.app/page6' />
