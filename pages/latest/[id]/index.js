...
const latestDetail = ({ latest }) => {
  ...
  const enhancedParagraph = text => {
    const linkTargets = [
      {
        text: 'Watch Online Wild Wild Punjab',
        url: 'https://azmovies.vercel.app/movies/watch-wild-wild-punjab-2024'
      },
      {
        text: 'Watch The Killer Trailer',
        url: 'https://azmovies.vercel.app/trailers/watch-the-killer-official-trailer-2024'
      },
      { text: 'A2Z Trailers', url: 'https://azmovies.vercel.app/trailers/' },
      { text: 'A2Z Movies', url: 'https://azmovies.vercel.app/movies/' },
      { text: 'A2Z Tv Shows', url: 'https://azmovies.vercel.app/yvshow/' },
      { text: 'A2Z Adult', url: 'https://azmovies.vercel.app/adult/' }
    ]
  ...
  useEffect(() => {
    ...
    setLinkTargets(
      getRandomLinks(moviesData, tvshowData, adultData, trailersData)
    )
  ...
  return (
    <div>
      <Head>
        ...
        <meta
          property='og:image'
          content={`${latest && latest.channelposter}`}
        />
