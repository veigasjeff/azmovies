...
const latestDetail = ({ latest }) => {
  ...
  const enhancedParagraph = (text) => {
    const linkTargets = [
      { text: 'The film Wild Wild Punjab', url: 'https://indianexpress.com/article/entertainment/movie-review/wild-wild-punjab-movie-review-fukrey-lite-varun-sharma-sunny-singh-luv-ranjan-9444280/' },
