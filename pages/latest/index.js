...
const softwareSchema = JSON.stringify({
  ...
  description:
    'Welcome to AZ Movies™ – your go-to spot for free online movies! Watch films from A to Z, enjoy HD streaming, and catch the latest trailers. Dive into cinema with AZ Movies™!',
...
const latestPage = ({ items }) => {
  ...
  return (
    <div className='w-full' style={{ backgroundColor: '#D3D3D3' }}>
      <Head>
        <title> Latest Movies News | AZMovies™</title>
        ...
        <meta property='og:title' content=' Latest Blog | AZMovies' />
        <meta
