...
const softwareSchema = JSON.stringify({
  ...
  headline: 'Download Latest | A to Z Movies™',
  url: 'https://azmovies.vercel.app/latest/',
  description:
    'A to Z Movies is the top platform for exploring and downloading software,the premier platform for the latest releases and secure downloads.',
    ...
    <div className='w-full' style={{ backgroundColor: '#D3D3D3' }}>
      <Head>
        ...
        <meta
          ...
          content='A to Z Movies is the top platform for exploring and downloading software,the premier platform for the Latest Blog releases and secure downloads.'
        />
      ...
      >
        A to Z Movies Latest Entertainment Section.
      </h1>
      {/* <Marquee /> */}
      {/* <p
