...
const softwareSchema = JSON.stringify({
  '@context': 'https://schema.org',
  '@type': 'Article',
  '@id': 'https://azmovies.vercel.app/latest-page1/',
  headline: ' Latest Blog | A to Z Movies™',
  url: 'https://azmovies.vercel.app/latest-page1/',
  description:
    'A to Z Movies is the top platform for exploring and downloading software,the premier platform for the Latest Blog releases and secure downloads.',
...
const breadcrumbSchema = JSON.stringify({
  ...
  itemListElement: [
    ...
    },
    {
      ...
      position: 3,
      name: 'Latest Page 1',
      item: 'https://azmovies.vercel.app/latest-page1/'
    }
  ]
})
  ...
  return (
    <div className='w-full' style={{ backgroundColor: '#D3D3D3' }}>
      <Head>
        ...
        <link rel='canonical' href='https://azmovies.vercel.app/latest-page1/' />
        <meta
          name='robots'
        ...
        <meta
          ...
          content='A to Z Movies is the top platform for exploring and downloading software,the premier platform for the latest-page1 releases and secure downloads.'
        />

        <meta
          property='og:url'
          content='https://azmovies.vercel.app/latest-page1'
        />
      ...
      >
        A to Z Movies Latest Blog Blog Section.
      </h1>
      {/* <Marquee /> */}
      {/* <p
...
export async function getStaticProps () {
  try {
    const res = await fetch('https://azmovies.vercel.app/latestp1.json')
