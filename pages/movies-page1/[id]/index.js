...
const moviesp1Detail = ({ moviesp1Item }) => {
  ...
  const rankMathSchema = JSON.stringify({
    ...
    '@graph': [
      ...
      },
      {
        ...
        name: `Watch ${moviesp1Item.name} | AZMovies™.`,
      ...
      },
      {
        ...
        headline: `Watch ${moviesp1Item.name} | AZMovies™.`,
        datePublished: moviesp1Item.datePublished,
        dateModified: moviesp1Item.dateModified,
        articleSection: 'Movies',
        author: {
          '@id': 'https://azmovies.vercel.app/author/moviesp1Item/'
        },
        publisher: {
          '@id': 'https://gravatar.com/drmovies2022/#person'
        },
  ...
  return (
    <div>
      <Head>
        ...
        />
        <title> {moviesp1Item && moviesp1Item.name}</title>
        ...
        <meta
          property='og:title'
          content={`${moviesp1Item && moviesp1Item.name} - AZMovies™.`}
        />
        <meta
      ...
      {isAdult && <AdultSkipAds movie={moviesp1Item} />}
      <script
