  ...
  return (
    <div>
      <Head>
        ...
        />
        <title> {movie && movie.name} | AtoZ™</title>
        ...
        <meta property='og:title' content={`${movie && movie.name} - AtoZ `} />
        <meta
      ...
      >
        ...
        {isTVShow && (
          <>
            ...
            <p className='text-lg bg-gradient-to-r from-pink-700 to-blue-700 bg-clip-text text-transparent mt-4'>
              Streaming <strong>{movie.title}</strong> on <strong>AtoZ </strong>{' '}
            ...
            <p className='text-lg bg-gradient-to-r from-pink-700 to-blue-700 bg-clip-text text-transparent mt-4'>
              ...
              <strong>{movie.title}</strong> on <strong>AtoZ </strong> is your
              go-to destination for streaming TV series online. Join our
              community of viewers and start watching{' '}
              <strong>{movie.title}</strong> today. With <strong>AtoZ </strong>,
        ...
        {isAdult && (
          <>
            ...
            <p className='text-lg bg-gradient-to-r from-pink-700 to-blue-700 bg-clip-text text-transparent mt-4'>
              ...
              <strong>{movie.title}</strong>. At <strong>AtoZ </strong>, we
            ...
            <p className='text-lg bg-gradient-to-r from-pink-700 to-blue-700 bg-clip-text text-transparent mt-4'>
              ...
              than <strong>{movie.title}</strong> on <strong>AtoZ </strong>. Our
        ...
        {!isTVShow && !isAdult && (
          <>
            ...
            <p className='text-lg bg-gradient-to-r from-pink-700 to-blue-700 bg-clip-text text-transparent mt-4'>
              ...
              <strong>{movie.title}</strong> on <strong>AtoZ </strong> is the
              perfect way to enjoy your movie night. Join the countless users
