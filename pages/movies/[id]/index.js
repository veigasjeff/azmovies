  ...
  const rankMathSchema = JSON.stringify({
    ...
    '@graph': [
      ...
      },
      {
        ...
        headline: ` ${movieszipItem.name} | AtoZ™`,
        datePublished: movieszipItem.datePublished,
        dateModified: movieszipItem.dateModified,
  ...
  return (
    <div>
      <Head>
        ...
        />
        <title> {movieszipItem.name} | AtoZ™</title>
        ...
        <meta
          property='og:title'
          content={`${movieszipItem && movieszipItem.name} - AtoZ™`}
        />
        <meta
          property='og:description'
          content='Stream HD movieszipItems and TV series for free on AtoZ™. Online. Stream. Download. full-length movieszipItems and shows in HD quality without registration.'
        />
        <meta
          name='description'
          content={`${movieszipItem.title} available on AtoZ™. Enjoy free streaming of full-length movieszipItems and TV series online with no registration required.`}
        />
        <meta
          property='og:url'
