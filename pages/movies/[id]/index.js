        ...
        {isTVShow && (
          <>
            ...
            <p className='text-lg text-yellow-500 mt-4'>
              ...
              <strong>{movie.title}</strong> on <strong>Justwatch™</strong> is
        ...
        {isAdult && (
          <>
            ...
            <p className='text-lg text-yellow-500 mt-4'>
              ...
              <strong>{movie.title}</strong>. At <strong>Justwatch™</strong>, we
            ...
            <p className='text-lg text-yellow-500 mt-4'>
              ...
              than <strong>{movie.title}</strong> on <strong>Justwatch™</strong>
        ...
        {!isTVShow && !isAdult && (
          <>
            ...
            <p className='text-lg text-yellow-500 mt-4'>
              ...
              available to stream right here. At <strong>Justwatch™</strong>, we
