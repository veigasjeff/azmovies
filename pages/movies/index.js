...
const softwareSchema = JSON.stringify({
  '@context': 'https://schema.org',
  '@type': 'Article',
  '@id': 'https://atozmovies.vercel.app/movies/',
  headline: 'Download Movies | AtoZ ™',
  url: 'https://atozmovies.vercel.app/movies/',
  description:
...
const breadcrumbSchema = JSON.stringify({
  ...
  itemListElement: [
    ...
    },
    {
      ...
      position: 2,
      name: 'Movie',
      item: 'https://atozmovies.vercel.app/movies/'
    }
  ]
})
...
const moviesPage = ({ items }) => {
  ...
  const currentPage = parseInt(router.pathname.replace('/enter', '')) || 1
  ...
  return (
    <div className='w-full' style={{ backgroundColor: '#D3D3D3' }}>
      <Head>
        <title> Watch Movies | AtoZ ™</title>
        <link rel='canonical' href='https://atozmovies.vercel.app/movies/' />
        <meta
          name='robots'
        ...
        <meta property='og:title' content=' Watch Movies | AtoZ ™' />
        <meta
        ...
        <meta property='og:url' content='https://atozmovies.vercel.app/movies' />
