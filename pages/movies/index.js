...
const softwareSchema = JSON.stringify({
  ...
  description:
    'Welcome to A to Z movies™ – your go-to spot for free online movies! Watch and enjoy HD streaming, and catch the latest moviess. Dive into cinema with A to Z movies™!',
...
const moviesPage = ({ items }) => {
  ...
  return (
    <div className='w-full' style={{ backgroundColor: '#D3D3D3' }}>
      <Head>
        <title> Watch A to Z Movies | A to Z Movies™</title>
        ...
        <meta property='og:title' content='  A to Z Movies™' />
        <meta
