...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    name: 'Watch Movie A Quiet Place Day One (2024) | AtoZ Movies™',
    alternateName: [
      'Ver película A Quiet Place Day One (2024) | AtoZ Movies™',
      'Regarder le film A Quiet Place Day One (2024) | AtoZ Movies™',
      'Film A Quiet Place Day One (2024) ansehen | AtoZ Movies™',
      '观看电影 A Quiet Place Day One (2024) | AtoZ Movies™',
      '映画 A Quiet Place Day One (2024) を見る | AtoZ Movies™',
      '영화 A Quiet Place Day One (2024) 보기 | AtoZ Movies™',
      'Assistir Filme A Quiet Place Day One (2024) | AtoZ Movies™',
      'Guarda il film A Quiet Place Day One (2024) | AtoZ Movies™',
      'Посмотреть фильм A Quiet Place Day One (2024) | AtoZ Movies™',
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie A Quiet Place Day One (2024) | AtoZ Movies™</title>
