...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    name: 'Watch Movie Alien: Romulus (2024) | AtoZ Movies™',
    alternateName: [
      'Ver película Alien: Romulus (2024) | AtoZ Movies™',
      'Regarder le film Alien: Romulus (2024) | AtoZ Movies™',
      'Film Alien: Romulus (2024) ansehen | AtoZ Movies™',
      '观看电影 Alien: Romulus (2024) | AtoZ Movies™',
      '映画 Alien: Romulus (2024) を見る | AtoZ Movies™',
      '영화 Alien: Romulus (2024) 보기 | AtoZ Movies™',
      'Assistir Filme Alien: Romulus (2024) | AtoZ Movies™',
      'Guarda il film Alien: Romulus (2024) | AtoZ Movies™',
      'Посмотреть фильм Alien: Romulus (2024) | AtoZ Movies™',
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie Alien: Romulus (2024) | AtoZ Movies™</title>
