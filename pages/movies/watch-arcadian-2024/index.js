...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    name: 'Watch Movie Arcadian (2024) | AtoZ Movies™',
    alternateName: [
      'Ver película Arcadian (2024) | AtoZ Movies™',
      'Regarder le film Arcadian (2024) | AtoZ Movies™',
      'Film Arcadian (2024) ansehen | AtoZ Movies™',
      '观看电影 Arcadian (2024) | AtoZ Movies™',
      '映画 Arcadian (2024) を見る | AtoZ Movies™',
      '영화 Arcadian (2024) 보기 | AtoZ Movies™',
      'Assistir Filme Arcadian (2024) | AtoZ Movies™',
      'Guarda il film Arcadian (2024) | AtoZ Movies™',
      'Посмотреть фильм Arcadian (2024) | AtoZ Movies™',
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie Arcadian (2024) | AtoZ Movies™</title>
