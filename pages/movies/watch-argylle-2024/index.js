...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    name: 'Watch Movie Argylle (2024) | AtoZ Movies™',
    alternateName: [
      'Ver película Argylle (2024) | AtoZ Movies™',
      'Regarder le film Argylle (2024) | AtoZ Movies™',
      'Film Argylle (2024) ansehen | AtoZ Movies™',
      '观看电影 Argylle (2024) | AtoZ Movies™',
      '映画 Argylle (2024) を見る | AtoZ Movies™',
      '영화 Argylle (2024) 보기 | AtoZ Movies™',
      'Assistir Filme Argylle (2024) | AtoZ Movies™',
      'Guarda il film Argylle (2024) | AtoZ Movies™',
      'Посмотреть фильм Argylle (2024) | AtoZ Movies™',
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie Argylle (2024) | AtoZ Movies™</title>
