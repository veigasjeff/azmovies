...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    name: 'Watch Movie Bardovi (2024) | AtoZ Movies™',
    alternateName: [
      'Ver película Bardovi (2024) | AtoZ Movies™',
      'Regarder le film Bardovi (2024) | AtoZ Movies™',
      'Film Bardovi (2024) ansehen | AtoZ Movies™',
      '观看电影 Bardovi (2024) | AtoZ Movies™',
      '映画 Bardovi (2024) を見る | AtoZ Movies™',
      '영화 Bardovi (2024) 보기 | AtoZ Movies™',
      'Assistir Filme Bardovi (2024) | AtoZ Movies™',
      'Guarda il film Bardovi (2024) | AtoZ Movies™',
      'Посмотреть фильм Bardovi (2024) | AtoZ Movies™',
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie Bardovi (2024) | AtoZ Movies™</title>
