...
const moviesDetail = ({ movie }) => {
  ...
  <meta name="description" content={`${movie.title} available on AtoZ Movies™. Enjoy free streaming of full-length movies and TV series online with no registration required.`} />
...
export async function getServerSideProps () {
  ...
  const selectedMovie = data.find(movie => movie.id === 'INDEXP1102')
  return {
    props: {
      movie: selectedMovie
    }
