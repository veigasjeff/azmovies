...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    name: 'Watch Movie Barzakh (2024) | AtoZ Movies™',
    alternateName: [
      'Ver película Barzakh (2024) | AtoZ Movies™',
      'Regarder le film Barzakh (2024) | AtoZ Movies™',
      'Film Barzakh (2024) ansehen | AtoZ Movies™',
      '观看电影 Barzakh (2024) | AtoZ Movies™',
      '映画 Barzakh (2024) を見る | AtoZ Movies™',
      '영화 Barzakh (2024) 보기 | AtoZ Movies™',
      'Assistir Filme Barzakh (2024) | AtoZ Movies™',
      'Guarda il film Barzakh (2024) | AtoZ Movies™',
      'Посмотреть фильм Barzakh (2024) | AtoZ Movies™',
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie Barzakh (2024) | AtoZ Movies™</title>
