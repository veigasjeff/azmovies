...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    name: 'Watch Movie Bloody Ishq (2024) | AtoZ Movies™',
    alternateName: [
      'Ver película Bloody Ishq (2024) | AtoZ Movies™',
      'Regarder le film Bloody Ishq (2024) | AtoZ Movies™',
      'Film Bloody Ishq (2024) ansehen | AtoZ Movies™',
      '观看电影 Bloody Ishq (2024) | AtoZ Movies™',
      '映画 Bloody Ishq (2024) を見る | AtoZ Movies™',
      '영화 Bloody Ishq (2024) 보기 | AtoZ Movies™',
      'Assistir Filme Bloody Ishq (2024) | AtoZ Movies™',
      'Guarda il film Bloody Ishq (2024) | AtoZ Movies™',
      'Посмотреть фильм Bloody Ishq (2024) | AtoZ Movies™',
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie Bloody Ishq (2024) | AtoZ Movies™</title>
