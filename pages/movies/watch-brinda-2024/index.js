...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    name: 'Watch Movie Brinda (2024) | AtoZ Movies™',
    alternateName: [
      'Ver película Brinda (2024) | AtoZ Movies™',
      'Regarder le film Brinda (2024) | AtoZ Movies™',
      'Film Brinda (2024) ansehen | AtoZ Movies™',
      '观看电影 Brinda (2024) | AtoZ Movies™',
      '映画 Brinda (2024) を見る | AtoZ Movies™',
      '영화 Brinda (2024) 보기 | AtoZ Movies™',
      'Assistir Filme Brinda (2024) | AtoZ Movies™',
      'Guarda il film Brinda (2024) | AtoZ Movies™',
      'Посмотреть фильм Brinda (2024) | AtoZ Movies™',
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie Brinda (2024) | AtoZ Movies™</title>
