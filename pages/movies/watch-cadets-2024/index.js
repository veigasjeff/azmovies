...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    name: 'Watch Movie Cadets (2024) | AtoZ Movies™',
    alternateName: [
      'Ver película Cadets (2024) | AtoZ Movies™',
      'Regarder le film Cadets (2024) | AtoZ Movies™',
      'Film Cadets (2024) ansehen | AtoZ Movies™',
      '观看电影 Cadets (2024) | AtoZ Movies™',
      '映画 Cadets (2024) を見る | AtoZ Movies™',
      '영화 Cadets (2024) 보기 | AtoZ Movies™',
      'Assistir Filme Cadets (2024) | AtoZ Movies™',
      'Guarda il film Cadets (2024) | AtoZ Movies™',
      'Посмотреть фильм Cadets (2024) | AtoZ Movies™',
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie Cadets (2024) | AtoZ Movies™</title>
