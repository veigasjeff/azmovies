...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    name: 'Watch Movie Continental Split (2024) | AtoZ Movies™',
    alternateName: [
      'Ver película Continental Split (2024) | AtoZ Movies™',
      'Regarder le film Continental Split (2024) | AtoZ Movies™',
      'Film Continental Split (2024) ansehen | AtoZ Movies™',
      '观看电影 Continental Split (2024) | AtoZ Movies™',
      '映画 Continental Split (2024) を見る | AtoZ Movies™',
      '영화 Continental Split (2024) 보기 | AtoZ Movies™',
      'Assistir Filme Continental Split (2024) | AtoZ Movies™',
      'Guarda il film Continental Split (2024) | AtoZ Movies™',
      'Посмотреть фильм Continental Split (2024) | AtoZ Movies™',
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie Continental Split (2024) | AtoZ Movies™</title>
