...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    name: 'Watch Movie Crescent City (2024) | AtoZ Movies™',
    alternateName: [
      'Ver película Crescent City (2024) | AtoZ Movies™',
      'Regarder le film Crescent City (2024) | AtoZ Movies™',
      'Film Crescent City (2024) ansehen | AtoZ Movies™',
      '观看电影 Crescent City (2024) | AtoZ Movies™',
      '映画 Crescent City (2024) を見る | AtoZ Movies™',
      '영화 Crescent City (2024) 보기 | AtoZ Movies™',
      'Assistir Filme Crescent City (2024) | AtoZ Movies™',
      'Guarda il film Crescent City (2024) | AtoZ Movies™',
      'Посмотреть фильм Crescent City (2024) | AtoZ Movies™',
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie Crescent City (2024) | AtoZ Movies™</title>
