...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    name: 'Watch Movie Detained (2024) | AtoZ Movies™',
    alternateName: [
      'Ver película Detained (2024) | AtoZ Movies™',
      'Regarder le film Detained (2024) | AtoZ Movies™',
      'Film Detained (2024) ansehen | AtoZ Movies™',
      '观看电影 Detained (2024) | AtoZ Movies™',
      '映画 Detained (2024) を見る | AtoZ Movies™',
      '영화 Detained (2024) 보기 | AtoZ Movies™',
      'Assistir Filme Detained (2024) | AtoZ Movies™',
      'Guarda il film Detained (2024) | AtoZ Movies™',
      'Посмотреть фильм Detained (2024) | AtoZ Movies™',
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie Detained (2024) | AtoZ Movies™</title>
