...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    name: 'Watch Movie Disciples in the Moonlight (2024) | AtoZ Movies™',
    alternateName: [
      'Ver película Disciples in the Moonlight (2024) | AtoZ Movies™',
      'Regarder le film Disciples in the Moonlight (2024) | AtoZ Movies™',
      'Film Disciples in the Moonlight (2024) ansehen | AtoZ Movies™',
      '观看电影 Disciples in the Moonlight (2024) | AtoZ Movies™',
      '映画 Disciples in the Moonlight (2024) を見る | AtoZ Movies™',
      '영화 Disciples in the Moonlight (2024) 보기 | AtoZ Movies™',
      'Assistir Filme Disciples in the Moonlight (2024) | AtoZ Movies™',
      'Guarda il film Disciples in the Moonlight (2024) | AtoZ Movies™',
      'Посмотреть фильм Disciples in the Moonlight (2024) | AtoZ Movies™',
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie Disciples in the Moonlight (2024) | AtoZ Movies™</title>
