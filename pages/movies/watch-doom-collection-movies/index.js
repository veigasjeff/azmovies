...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    name: 'Watch Movie Doom Collection (2024) | AtoZ Movies™',
    alternateName: [
      'Ver película Doom Collection (2024) | AtoZ Movies™',
      'Regarder le film Doom Collection (2024) | AtoZ Movies™',
      'Film Doom Collection (2024) ansehen | AtoZ Movies™',
      '观看电影 Doom Collection (2024) | AtoZ Movies™',
      '映画 Doom Collection (2024) を見る | AtoZ Movies™',
      '영화 Doom Collection (2024) 보기 | AtoZ Movies™',
      'Assistir Filme Doom Collection (2024) | AtoZ Movies™',
      'Guarda il film Doom Collection (2024) | AtoZ Movies™',
      'Посмотреть фильм Doom Collection (2024) | AtoZ Movies™',
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie Doom Collection (2024) | AtoZ Movies™</title>
