...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    name: 'Watch Movie Escape From Germany (2024) | AtoZ Movies™',
    alternateName: [
      'Ver película Escape From Germany (2024) | AtoZ Movies™',
      'Regarder le film Escape From Germany (2024) | AtoZ Movies™',
      'Film Escape From Germany (2024) ansehen | AtoZ Movies™',
      '观看电影 Escape From Germany (2024) | AtoZ Movies™',
      '映画 Escape From Germany (2024) を見る | AtoZ Movies™',
      '영화 Escape From Germany (2024) 보기 | AtoZ Movies™',
      'Assistir Filme Escape From Germany (2024) | AtoZ Movies™',
      'Guarda il film Escape From Germany (2024) | AtoZ Movies™',
      'Посмотреть фильм Escape From Germany (2024) | AtoZ Movies™',
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie Escape From Germany (2024) | AtoZ Movies™</title>
