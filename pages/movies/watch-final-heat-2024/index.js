...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    name: 'Watch Movie Final Heat (2024) | AtoZ Movies™',
    alternateName: [
      'Ver película Final Heat (2024) | AtoZ Movies™',
      'Regarder le film Final Heat (2024) | AtoZ Movies™',
      'Film Final Heat (2024) ansehen | AtoZ Movies™',
      '观看电影 Final Heat (2024) | AtoZ Movies™',
      '映画 Final Heat (2024) を見る | AtoZ Movies™',
      '영화 Final Heat (2024) 보기 | AtoZ Movies™',
      'Assistir Filme Final Heat (2024) | AtoZ Movies™',
      'Guarda il film Final Heat (2024) | AtoZ Movies™',
      'Посмотреть фильм Final Heat (2024) | AtoZ Movies™',
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie Final Heat (2024) | AtoZ Movies™</title>
