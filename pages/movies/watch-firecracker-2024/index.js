...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    name: 'Watch Movie Firecracker (2024) | AtoZ Movies™',
    alternateName: [
      'Ver película Firecracker (2024) | AtoZ Movies™',
      'Regarder le film Firecracker (2024) | AtoZ Movies™',
      'Film Firecracker (2024) ansehen | AtoZ Movies™',
      '观看电影 Firecracker (2024) | AtoZ Movies™',
      '映画 Firecracker (2024) を見る | AtoZ Movies™',
      '영화 Firecracker (2024) 보기 | AtoZ Movies™',
      'Assistir Filme Firecracker (2024) | AtoZ Movies™',
      'Guarda il film Firecracker (2024) | AtoZ Movies™',
      'Посмотреть фильм Firecracker (2024) | AtoZ Movies™',
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie Firecracker (2024) | AtoZ Movies™</title>
