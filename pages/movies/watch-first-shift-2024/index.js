...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    name: 'Watch Movie First Shift (2024) | AtoZ Movies™',
    alternateName: [
      'Ver película First Shift (2024) | AtoZ Movies™',
      'Regarder le film First Shift (2024) | AtoZ Movies™',
      'Film First Shift (2024) ansehen | AtoZ Movies™',
      '观看电影 First Shift (2024) | AtoZ Movies™',
      '映画 First Shift (2024) を見る | AtoZ Movies™',
      '영화 First Shift (2024) 보기 | AtoZ Movies™',
      'Assistir Filme First Shift (2024) | AtoZ Movies™',
      'Guarda il film First Shift (2024) | AtoZ Movies™',
      'Посмотреть фильм First Shift (2024) | AtoZ Movies™',
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie First Shift (2024) | AtoZ Movies™</title>
