...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    name: 'Watch Movie Ghudchadi (2024) | AtoZ Movies™',
    alternateName: [
      'Ver película Ghudchadi (2024) | AtoZ Movies™',
      'Regarder le film Ghudchadi (2024) | AtoZ Movies™',
      'Film Ghudchadi (2024) ansehen | AtoZ Movies™',
      '观看电影 Ghudchadi (2024) | AtoZ Movies™',
      '映画 Ghudchadi (2024) を見る | AtoZ Movies™',
      '영화 Ghudchadi (2024) 보기 | AtoZ Movies™',
      'Assistir Filme Ghudchadi (2024) | AtoZ Movies™',
      'Guarda il film Ghudchadi (2024) | AtoZ Movies™',
      'Посмотреть фильм Ghudchadi (2024) | AtoZ Movies™',
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie Ghudchadi (2024) | AtoZ Movies™</title>
