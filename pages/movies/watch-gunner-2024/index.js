...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    name: 'Watch Movie Gunner (2024) | AtoZ Movies™',
    alternateName: [
      'Ver película Gunner (2024) | AtoZ Movies™',
      'Regarder le film Gunner (2024) | AtoZ Movies™',
      'Film Gunner (2024) ansehen | AtoZ Movies™',
      '观看电影 Gunner (2024) | AtoZ Movies™',
      '映画 Gunner (2024) を見る | AtoZ Movies™',
      '영화 Gunner (2024) 보기 | AtoZ Movies™',
      'Assistir Filme Gunner (2024) | AtoZ Movies™',
      'Guarda il film Gunner (2024) | AtoZ Movies™',
      'Посмотреть фильм Gunner (2024) | AtoZ Movies™',
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie Gunner (2024) | AtoZ Movies™</title>
