...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    name: 'Watch Movie Hard Home (2024) | AtoZ Movies™',
    alternateName: [
      'Ver película Hard Home (2024) | AtoZ Movies™',
      'Regarder le film Hard Home (2024) | AtoZ Movies™',
      'Film Hard Home (2024) ansehen | AtoZ Movies™',
      '观看电影 Hard Home (2024) | AtoZ Movies™',
      '映画 Hard Home (2024) を見る | AtoZ Movies™',
      '영화 Hard Home (2024) 보기 | AtoZ Movies™',
      'Assistir Filme Hard Home (2024) | AtoZ Movies™',
      'Guarda il film Hard Home (2024) | AtoZ Movies™',
      'Посмотреть фильм Hard Home (2024) | AtoZ Movies™',
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie Hard Home (2024) | AtoZ Movies™</title>
