...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    name: 'Watch Movie Harold and the Purple Crayon (2024) | AtoZ Movies™',
    alternateName: [
      'Ver película Harold and the Purple Crayon (2024) | AtoZ Movies™',
      'Regarder le film Harold and the Purple Crayon (2024) | AtoZ Movies™',
      'Film Harold and the Purple Crayon (2024) ansehen | AtoZ Movies™',
      '观看电影 Harold and the Purple Crayon (2024) | AtoZ Movies™',
      '映画 Harold and the Purple Crayon (2024) を見る | AtoZ Movies™',
      '영화 Harold and the Purple Crayon (2024) 보기 | AtoZ Movies™',
      'Assistir Filme Harold and the Purple Crayon (2024) | AtoZ Movies™',
      'Guarda il film Harold and the Purple Crayon (2024) | AtoZ Movies™',
      'Посмотреть фильм Harold and the Purple Crayon (2024) | AtoZ Movies™',
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie Harold and the Purple Crayon (2024) | AtoZ Movies™</title>
