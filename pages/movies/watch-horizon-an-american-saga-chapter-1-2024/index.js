...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    name: 'Watch Movie Horizon: An American Saga Chapter 1 (2024) | AtoZ Movies™',
    alternateName: [
      'Ver película Horizon: An American Saga Chapter 1 (2024) | AtoZ Movies™',
      'Regarder le film Horizon: An American Saga Chapter 1 (2024) | AtoZ Movies™',
      'Film Horizon: An American Saga Chapter 1 (2024) ansehen | AtoZ Movies™',
      '观看电影 Horizon: An American Saga Chapter 1 (2024) | AtoZ Movies™',
      '映画 Horizon: An American Saga Chapter 1 (2024) を見る | AtoZ Movies™',
      '영화 Horizon: An American Saga Chapter 1 (2024) 보기 | AtoZ Movies™',
      'Assistir Filme Horizon: An American Saga Chapter 1 (2024) | AtoZ Movies™',
      'Guarda il film Horizon: An American Saga Chapter 1 (2024) | AtoZ Movies™',
      'Посмотреть фильм Horizon: An American Saga Chapter 1 (2024) | AtoZ Movies™',
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie Horizon: An American Saga Chapter 1 (2024) | AtoZ Movies™</title>
        ...
        <meta
          property='og:title'
          content={`${movie && movie.name} - AtoZ Movies™`}
        />
        <meta
        ...
        <meta
          name='description'
          content={`${movie.title} available on AtoZ Movies™. Enjoy free streaming of full-length movies and TV series online with no registration required.`}
        />
        ...
        {isTVShow && (
          <>
            ...
            <p className='text-lg text-yellow-500 mt-4'>
              ...
              <strong> AtoZ Movies™</strong>, you can stream{' '}
            ...
            <p className='text-lg text-yellow-500 mt-4'>
              ...
              <strong>{movie.title}</strong> on <strong>AtoZ Movies™</strong> is
...
export async function getServerSideProps () {
  const res = await fetch('https://atozmovies.vercel.app/moviesp4.json')
