...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    name: 'Watch Movie Incoming (2024) | AtoZ Movies™',
    alternateName: [
      'Ver película Incoming (2024) | AtoZ Movies™',
      'Regarder le film Incoming (2024) | AtoZ Movies™',
      'Film Incoming (2024) ansehen | AtoZ Movies™',
      '观看电影 Incoming (2024) | AtoZ Movies™',
      '映画 Incoming (2024) を見る | AtoZ Movies™',
      '영화 Incoming (2024) 보기 | AtoZ Movies™',
      'Assistir Filme Incoming (2024) | AtoZ Movies™',
      'Guarda il film Incoming (2024) | AtoZ Movies™',
      'Посмотреть фильм Incoming (2024) | AtoZ Movies™',
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie Incoming (2024) | AtoZ Movies™</title>
