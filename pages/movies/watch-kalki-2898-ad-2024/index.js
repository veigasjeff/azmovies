...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    name: 'Watch Movie Kalki 2898 AD (2024) | AtoZ Movies™',
    alternateName: [
      'Ver película Kalki 2898 AD (2024) | AtoZ Movies™',
      'Regarder le film Kalki 2898 AD (2024) | AtoZ Movies™',
      'Film Kalki 2898 AD (2024) ansehen | AtoZ Movies™',
      '观看电影 Kalki 2898 AD (2024) | AtoZ Movies™',
      '映画 Kalki 2898 AD (2024) を見る | AtoZ Movies™',
      '영화 Kalki 2898 AD (2024) 보기 | AtoZ Movies™',
      'Assistir Filme Kalki 2898 AD (2024) | AtoZ Movies™',
      'Guarda il film Kalki 2898 AD (2024) | AtoZ Movies™',
      'Посмотреть фильм Kalki 2898 AD (2024) | AtoZ Movies™',
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie Kalki 2898 AD (2024) | AtoZ Movies™</title>
