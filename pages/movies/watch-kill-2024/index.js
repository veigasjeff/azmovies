...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    name: 'Watch Movie Kill (2024) | AtoZ Movies™',
    alternateName: [
      'Ver película Kill (2024) | AtoZ Movies™',
      'Regarder le film Kill (2024) | AtoZ Movies™',
      'Film Kill (2024) ansehen | AtoZ Movies™',
      '观看电影 Kill (2024) | AtoZ Movies™',
      '映画 Kill (2024) を見る | AtoZ Movies™',
      '영화 Kill (2024) 보기 | AtoZ Movies™',
      'Assistir Filme Kill (2024) | AtoZ Movies™',
      'Guarda il film Kill (2024) | AtoZ Movies™',
      'Посмотреть фильм Kill (2024) | AtoZ Movies™',
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie Kill (2024) | AtoZ Movies™</title>
