...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    name: 'Watch Movie Latency (2024) | AtoZ Movies™',
    alternateName: [
      'Ver película Latency (2024) | AtoZ Movies™',
      'Regarder le film Latency (2024) | AtoZ Movies™',
      'Film Latency (2024) ansehen | AtoZ Movies™',
      '观看电影 Latency (2024) | AtoZ Movies™',
      '映画 Latency (2024) を見る | AtoZ Movies™',
      '영화 Latency (2024) 보기 | AtoZ Movies™',
      'Assistir Filme Latency (2024) | AtoZ Movies™',
      'Guarda il film Latency (2024) | AtoZ Movies™',
      'Посмотреть фильм Latency (2024) | AtoZ Movies™',
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie Latency (2024) | AtoZ Movies™</title>
