...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    name: 'Watch Movie Madgaon Express (2024) | AtoZ Movies™',
    alternateName: [
      'Ver película Madgaon Express (2024) | AtoZ Movies™',
      'Regarder le film Madgaon Express (2024) | AtoZ Movies™',
      'Film Madgaon Express (2024) ansehen | AtoZ Movies™',
      '观看电影 Madgaon Express (2024) | AtoZ Movies™',
      '映画 Madgaon Express (2024) を見る | AtoZ Movies™',
      '영화 Madgaon Express (2024) 보기 | AtoZ Movies™',
      'Assistir Filme Madgaon Express (2024) | AtoZ Movies™',
      'Guarda il film Madgaon Express (2024) | AtoZ Movies™',
      'Посмотреть фильм Madgaon Express (2024) | AtoZ Movies™',
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie Madgaon Express (2024) | AtoZ Movies™</title>
