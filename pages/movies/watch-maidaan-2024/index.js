...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    name: 'Watch Movie Maidaan (2024) | AtoZ Movies™',
    alternateName: [
      'Ver película Maidaan (2024) | AtoZ Movies™',
      'Regarder le film Maidaan (2024) | AtoZ Movies™',
      'Film Maidaan (2024) ansehen | AtoZ Movies™',
      '观看电影 Maidaan (2024) | AtoZ Movies™',
      '映画 Maidaan (2024) を見る | AtoZ Movies™',
      '영화 Maidaan (2024) 보기 | AtoZ Movies™',
      'Assistir Filme Maidaan (2024) | AtoZ Movies™',
      'Guarda il film Maidaan (2024) | AtoZ Movies™',
      'Посмотреть фильм Maidaan (2024) | AtoZ Movies™',
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie Maidaan (2024) | AtoZ Movies™</title>
