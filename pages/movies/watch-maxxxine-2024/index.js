...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    name: 'Watch Movie MaXXXine (2024) | AtoZ Movies™',
    alternateName: [
      'Ver película MaXXXine (2024) | AtoZ Movies™',
      'Regarder le film MaXXXine (2024) | AtoZ Movies™',
      'Film MaXXXine (2024) ansehen | AtoZ Movies™',
      '观看电影 MaXXXine (2024) | AtoZ Movies™',
      '映画 MaXXXine (2024) を見る | AtoZ Movies™',
      '영화 MaXXXine (2024) 보기 | AtoZ Movies™',
      'Assistir Filme MaXXXine (2024) | AtoZ Movies™',
      'Guarda il film MaXXXine (2024) | AtoZ Movies™',
      'Посмотреть фильм MaXXXine (2024) | AtoZ Movies™',
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie MaXXXine (2024) | AtoZ Movies™</title>
