...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    name: 'Watch Movie Mission: Cross (2024) | AtoZ Movies™',
    alternateName: [
      'Ver película Mission: Cross (2024) | AtoZ Movies™',
      'Regarder le film Mission: Cross (2024) | AtoZ Movies™',
      'Film Mission: Cross (2024) ansehen | AtoZ Movies™',
      '观看电影 Mission: Cross (2024) | AtoZ Movies™',
      '映画 Mission: Cross (2024) を見る | AtoZ Movies™',
      '영화 Mission: Cross (2024) 보기 | AtoZ Movies™',
      'Assistir Filme Mission: Cross (2024) | AtoZ Movies™',
      'Guarda il film Mission: Cross (2024) | AtoZ Movies™',
      'Посмотреть фильм Mission: Cross (2024) | AtoZ Movies™',
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie Mission: Cross (2024) | AtoZ Movies™</title>
