...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    name: 'Watch Movie Murshid (2024) | AtoZ Movies™',
    alternateName: [
      'Ver película Murshid (2024) | AtoZ Movies™',
      'Regarder le film Murshid (2024) | AtoZ Movies™',
      'Film Murshid (2024) ansehen | AtoZ Movies™',
      '观看电影 Murshid (2024) | AtoZ Movies™',
      '映画 Murshid (2024) を見る | AtoZ Movies™',
      '영화 Murshid (2024) 보기 | AtoZ Movies™',
      'Assistir Filme Murshid (2024) | AtoZ Movies™',
      'Guarda il film Murshid (2024) | AtoZ Movies™',
      'Посмотреть фильм Murshid (2024) | AtoZ Movies™',
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie Murshid (2024) | AtoZ Movies™</title>
