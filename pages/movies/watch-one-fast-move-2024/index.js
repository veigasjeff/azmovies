...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    name: 'Watch Movie One Fast Move (2024) | AtoZ Movies™',
    alternateName: [
      'Ver película One Fast Move (2024) | AtoZ Movies™',
      'Regarder le film One Fast Move (2024) | AtoZ Movies™',
      'Film One Fast Move (2024) ansehen | AtoZ Movies™',
      '观看电影 One Fast Move (2024) | AtoZ Movies™',
      '映画 One Fast Move (2024) を見る | AtoZ Movies™',
      '영화 One Fast Move (2024) 보기 | AtoZ Movies™',
      'Assistir Filme One Fast Move (2024) | AtoZ Movies™',
      'Guarda il film One Fast Move (2024) | AtoZ Movies™',
      'Посмотреть фильм One Fast Move (2024) | AtoZ Movies™',
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie One Fast Move (2024) | AtoZ Movies™</title>
