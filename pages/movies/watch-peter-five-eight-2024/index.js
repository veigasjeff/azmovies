...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    name: 'Watch Movie Peter Five Eight (2024) | AtoZ Movies™',
    alternateName: [
      'Ver película Peter Five Eight (2024) | AtoZ Movies™',
      'Regarder le film Peter Five Eight (2024) | AtoZ Movies™',
      'Film Peter Five Eight (2024) ansehen | AtoZ Movies™',
      '观看电影 Peter Five Eight (2024) | AtoZ Movies™',
      '映画 Peter Five Eight (2024) を見る | AtoZ Movies™',
      '영화 Peter Five Eight (2024) 보기 | AtoZ Movies™',
      'Assistir Filme Peter Five Eight (2024) | AtoZ Movies™',
      'Guarda il film Peter Five Eight (2024) | AtoZ Movies™',
      'Посмотреть фильм Peter Five Eight (2024) | AtoZ Movies™',
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie Peter Five Eight (2024) | AtoZ Movies™</title>
