...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    name: 'Watch Movie Rebel Moon - Part Two: The Scargiver (2024) | AtoZ Movies™',
    alternateName: [
      'Ver película Rebel Moon - Part Two: The Scargiver (2024) | AtoZ Movies™',
      'Regarder le film Rebel Moon - Part Two: The Scargiver (2024) | AtoZ Movies™',
      'Film Rebel Moon - Part Two: The Scargiver (2024) ansehen | AtoZ Movies™',
      '观看电影 Rebel Moon - Part Two: The Scargiver (2024) | AtoZ Movies™',
      '映画 Rebel Moon - Part Two: The Scargiver (2024) を見る | AtoZ Movies™',
      '영화 Rebel Moon - Part Two: The Scargiver (2024) 보기 | AtoZ Movies™',
      'Assistir Filme Rebel Moon - Part Two: The Scargiver (2024) | AtoZ Movies™',
      'Guarda il film Rebel Moon - Part Two: The Scargiver (2024) | AtoZ Movies™',
      'Посмотреть фильм Rebel Moon - Part Two: The Scargiver (2024) | AtoZ Movies™',
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie Rebel Moon - Part Two: The Scargiver (2024) | AtoZ Movies™</title>
