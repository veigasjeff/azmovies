...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    name: 'Watch Movie Revolver (2024) | AtoZ Movies™',
    alternateName: [
      'Ver película Revolver (2024) | AtoZ Movies™',
      'Regarder le film Revolver (2024) | AtoZ Movies™',
      'Film Revolver (2024) ansehen | AtoZ Movies™',
      '观看电影 Revolver (2024) | AtoZ Movies™',
      '映画 Revolver (2024) を見る | AtoZ Movies™',
      '영화 Revolver (2024) 보기 | AtoZ Movies™',
      'Assistir Filme Revolver (2024) | AtoZ Movies™',
      'Guarda il film Revolver (2024) | AtoZ Movies™',
      'Посмотреть фильм Revolver (2024) | AtoZ Movies™',
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie Revolver (2024) | AtoZ Movies™</title>
