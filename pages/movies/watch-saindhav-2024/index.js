...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    name: 'Watch Movie Saindhav (2024) | AtoZ Movies™',
    alternateName: [
      'Ver película Saindhav (2024) | AtoZ Movies™',
      'Regarder le film Saindhav (2024) | AtoZ Movies™',
      'Film Saindhav (2024) ansehen | AtoZ Movies™',
      '观看电影 Saindhav (2024) | AtoZ Movies™',
      '映画 Saindhav (2024) を見る | AtoZ Movies™',
      '영화 Saindhav (2024) 보기 | AtoZ Movies™',
      'Assistir Filme Saindhav (2024) | AtoZ Movies™',
      'Guarda il film Saindhav (2024) | AtoZ Movies™',
      'Посмотреть фильм Saindhav (2024) | AtoZ Movies™',
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie Saindhav (2024) | AtoZ Movies™</title>
