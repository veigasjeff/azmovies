...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    name: 'Watch Movie Savi (2024) | AtoZ Movies™',
    alternateName: [
      'Ver película Savi (2024) | AtoZ Movies™',
      'Regarder le film Savi (2024) | AtoZ Movies™',
      'Film Savi (2024) ansehen | AtoZ Movies™',
      '观看电影 Savi (2024) | AtoZ Movies™',
      '映画 Savi (2024) を見る | AtoZ Movies™',
      '영화 Savi (2024) 보기 | AtoZ Movies™',
      'Assistir Filme Savi (2024) | AtoZ Movies™',
      'Guarda il film Savi (2024) | AtoZ Movies™',
      'Посмотреть фильм Savi (2024) | AtoZ Movies™',
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie Savi (2024) | AtoZ Movies™</title>
