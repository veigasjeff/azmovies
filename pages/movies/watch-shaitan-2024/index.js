...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    name: 'Watch Movie Shaitan (2024) | AtoZ Movies™',
    alternateName: [
      'Ver película Shaitan (2024) | AtoZ Movies™',
      'Regarder le film Shaitan (2024) | AtoZ Movies™',
      'Film Shaitan (2024) ansehen | AtoZ Movies™',
      '观看电影 Shaitan (2024) | AtoZ Movies™',
      '映画 Shaitan (2024) を見る | AtoZ Movies™',
      '영화 Shaitan (2024) 보기 | AtoZ Movies™',
      'Assistir Filme Shaitan (2024) | AtoZ Movies™',
      'Guarda il film Shaitan (2024) | AtoZ Movies™',
      'Посмотреть фильм Shaitan (2024) | AtoZ Movies™',
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie Shaitan (2024) | AtoZ Movies™</title>
