...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    name: 'Watch Movie Showtime (2024) | AtoZ Movies™',
    alternateName: [
      'Ver película Showtime (2024) | AtoZ Movies™',
      'Regarder le film Showtime (2024) | AtoZ Movies™',
      'Film Showtime (2024) ansehen | AtoZ Movies™',
      '观看电影 Showtime (2024) | AtoZ Movies™',
      '映画 Showtime (2024) を見る | AtoZ Movies™',
      '영화 Showtime (2024) 보기 | AtoZ Movies™',
      'Assistir Filme Showtime (2024) | AtoZ Movies™',
      'Guarda il film Showtime (2024) | AtoZ Movies™',
      'Посмотреть фильм Showtime (2024) | AtoZ Movies™',
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie Showtime (2024) | AtoZ Movies™</title>
