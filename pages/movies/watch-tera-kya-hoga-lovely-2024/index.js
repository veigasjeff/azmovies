...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    name: 'Watch Movie Tera Kya Hoga Lovely (2024) | AtoZ Movies™',
    alternateName: [
      'Ver película Tera Kya Hoga Lovely (2024) | AtoZ Movies™',
      'Regarder le film Tera Kya Hoga Lovely (2024) | AtoZ Movies™',
      'Film Tera Kya Hoga Lovely (2024) ansehen | AtoZ Movies™',
      '观看电影 Tera Kya Hoga Lovely (2024) | AtoZ Movies™',
      '映画 Tera Kya Hoga Lovely (2024) を見る | AtoZ Movies™',
      '영화 Tera Kya Hoga Lovely (2024) 보기 | AtoZ Movies™',
      'Assistir Filme Tera Kya Hoga Lovely (2024) | AtoZ Movies™',
      'Guarda il film Tera Kya Hoga Lovely (2024) | AtoZ Movies™',
      'Посмотреть фильм Tera Kya Hoga Lovely (2024) | AtoZ Movies™',
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie Tera Kya Hoga Lovely (2024) | AtoZ Movies™</title>
