...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    name: 'Watch Movie Crew (2024) | AtoZ Movies™',
    alternateName: [
      'Ver película Crew (2024) | AtoZ Movies™',
      'Regarder le film Crew (2024) | AtoZ Movies™',
      'Film Crew (2024) ansehen | AtoZ Movies™',
      '观看电影 Crew (2024) | AtoZ Movies™',
      '映画 Crew (2024) を見る | AtoZ Movies™',
      '영화 Crew (2024) 보기 | AtoZ Movies™',
      'Assistir Filme Crew (2024) | AtoZ Movies™',
      'Guarda il film Crew (2024) | AtoZ Movies™',
      'Посмотреть фильм Crew (2024) | AtoZ Movies™',
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie Crew (2024) | AtoZ Movies™</title>
