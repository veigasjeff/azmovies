...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    name: 'Watch Movie The Exorcism (2024) | AtoZ Movies™',
    alternateName: [
      'Ver película The Exorcism (2024) | AtoZ Movies™',
      'Regarder le film The Exorcism (2024) | AtoZ Movies™',
      'Film The Exorcism (2024) ansehen | AtoZ Movies™',
      '观看电影 The Exorcism (2024) | AtoZ Movies™',
      '映画 The Exorcism (2024) を見る | AtoZ Movies™',
      '영화 The Exorcism (2024) 보기 | AtoZ Movies™',
      'Assistir Filme The Exorcism (2024) | AtoZ Movies™',
      'Guarda il film The Exorcism (2024) | AtoZ Movies™',
      'Посмотреть фильм The Exorcism (2024) | AtoZ Movies™',
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie The Exorcism (2024) | AtoZ Movies™</title>
