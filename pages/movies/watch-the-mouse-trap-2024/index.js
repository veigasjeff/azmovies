...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    name: 'Watch Movie The Mouse Trap (2024) | AtoZ Movies™',
    alternateName: [
      'Ver película The Mouse Trap (2024) | AtoZ Movies™',
      'Regarder le film The Mouse Trap (2024) | AtoZ Movies™',
      'Film The Mouse Trap (2024) ansehen | AtoZ Movies™',
      '观看电影 The Mouse Trap (2024) | AtoZ Movies™',
      '映画 The Mouse Trap (2024) を見る | AtoZ Movies™',
      '영화 The Mouse Trap (2024) 보기 | AtoZ Movies™',
      'Assistir Filme The Mouse Trap (2024) | AtoZ Movies™',
      'Guarda il film The Mouse Trap (2024) | AtoZ Movies™',
      'Посмотреть фильм The Mouse Trap (2024) | AtoZ Movies™',
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie The Mouse Trap (2024) | AtoZ Movies™</title>
