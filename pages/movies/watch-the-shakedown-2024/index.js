...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    name: 'Watch Movie The Shakedown (2024) | AtoZ Movies™',
    alternateName: [
      'Ver película The Shakedown (2024) | AtoZ Movies™',
      'Regarder le film The Shakedown (2024) | AtoZ Movies™',
      'Film The Shakedown (2024) ansehen | AtoZ Movies™',
      '观看电影 The Shakedown (2024) | AtoZ Movies™',
      '映画 The Shakedown (2024) を見る | AtoZ Movies™',
      '영화 The Shakedown (2024) 보기 | AtoZ Movies™',
      'Assistir Filme The Shakedown (2024) | AtoZ Movies™',
      'Guarda il film The Shakedown (2024) | AtoZ Movies™',
      'Посмотреть фильм The Shakedown (2024) | AtoZ Movies™',
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie The Shakedown (2024) | AtoZ Movies™</title>
