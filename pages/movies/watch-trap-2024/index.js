...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    name: 'Watch Movie Trap (2024) | AtoZ Movies™',
    alternateName: [
      'Ver película Trap (2024) | AtoZ Movies™',
      'Regarder le film Trap (2024) | AtoZ Movies™',
      'Film Trap (2024) ansehen | AtoZ Movies™',
      '观看电影 Trap (2024) | AtoZ Movies™',
      '映画 Trap (2024) を見る | AtoZ Movies™',
      '영화 Trap (2024) 보기 | AtoZ Movies™',
      'Assistir Filme Trap (2024) | AtoZ Movies™',
      'Guarda il film Trap (2024) | AtoZ Movies™',
      'Посмотреть фильм Trap (2024) | AtoZ Movies™',
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie Trap (2024) | AtoZ Movies™</title>
