...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    name: 'Watch Movie Trigger Warning (2024) | AtoZ Movies™',
    alternateName: [
      'Ver película Trigger Warning (2024) | AtoZ Movies™',
      'Regarder le film Trigger Warning (2024) | AtoZ Movies™',
      'Film Trigger Warning (2024) ansehen | AtoZ Movies™',
      '观看电影 Trigger Warning (2024) | AtoZ Movies™',
      '映画 Trigger Warning (2024) を見る | AtoZ Movies™',
      '영화 Trigger Warning (2024) 보기 | AtoZ Movies™',
      'Assistir Filme Trigger Warning (2024) | AtoZ Movies™',
      'Guarda il film Trigger Warning (2024) | AtoZ Movies™',
      'Посмотреть фильм Trigger Warning (2024) | AtoZ Movies™',
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie Trigger Warning (2024) | AtoZ Movies™</title>
