...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    name: 'Watch Movie Twisters (2024) | AtoZ Movies™',
    alternateName: [
      'Ver película Twisters (2024) | AtoZ Movies™',
      'Regarder le film Twisters (2024) | AtoZ Movies™',
      'Film Twisters (2024) ansehen | AtoZ Movies™',
      '观看电影 Twisters (2024) | AtoZ Movies™',
      '映画 Twisters (2024) を見る | AtoZ Movies™',
      '영화 Twisters (2024) 보기 | AtoZ Movies™',
      'Assistir Filme Twisters (2024) | AtoZ Movies™',
      'Guarda il film Twisters (2024) | AtoZ Movies™',
      'Посмотреть фильм Twisters (2024) | AtoZ Movies™',
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie Twisters (2024) | AtoZ Movies™</title>
