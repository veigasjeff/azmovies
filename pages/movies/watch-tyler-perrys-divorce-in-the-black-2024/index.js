...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    name: 'Watch Movie Tyler Perrys Divorce in the Black (2024) | AtoZ Movies™',
    alternateName: [
      'Ver película Tyler Perrys Divorce in the Black (2024) | AtoZ Movies™',
      'Regarder le film Tyler Perrys Divorce in the Black (2024) | AtoZ Movies™',
      'Film Tyler Perrys Divorce in the Black (2024) ansehen | AtoZ Movies™',
      '观看电影 Tyler Perrys Divorce in the Black (2024) | AtoZ Movies™',
      '映画 Tyler Perrys Divorce in the Black (2024) を見る | AtoZ Movies™',
      '영화 Tyler Perrys Divorce in the Black (2024) 보기 | AtoZ Movies™',
      'Assistir Filme Tyler Perrys Divorce in the Black (2024) | AtoZ Movies™',
      'Guarda il film Tyler Perrys Divorce in the Black (2024) | AtoZ Movies™',
      'Посмотреть фильм Tyler Perrys Divorce in the Black (2024) | AtoZ Movies™',
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie Tyler Perrys Divorce in the Black (2024) | AtoZ Movies™</title>
...
export async function getServerSideProps () {
  const res = await fetch('https://atozmovies.vercel.app/moviesp2.json')
