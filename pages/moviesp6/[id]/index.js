...
const fetchmoviesData = async () => {
  const response = await fetch('https://atozmovies.vercel.app/moviesp6.json')
...
const moviesDetail6 = ({ moviesItem }) => {
  ...
  const enhancedParagraph = (text, moviesItem) => {
    ...
    const linkTargets = [
      ...
      {
        text: words[1] || '',
        url: 'https://atozmovies.vercel.app/trailers/watch-Ang-Kapitbahay-official-trailer-2024'
      },
      {
        text: words[2] || '',
        url: 'https://atozmovies.vercel.app/trailers/watch-Raat-Baaki-Hai-Part-01-trailer-2024'
      },
      {
        text: words[3] || '',
        url: 'https://atozmovies.vercel.app/trailers/watch-Sona-Part-official-trailer-2024'
      },
      {
        text: words[4] || '',
        url: 'https://atozmovies.vercel.app/trailers/watch-plaget-official-trailer-2024'
      }
    ]
  ...
  const rankMathSchema = JSON.stringify({
    ...
    '@graph': [
      ...
      },
      {
        ...
        name: `${moviesItem.name} | AtoZ Movies™`,
...

      {
        ...
        headline: ` ${moviesItem.name} | AtoZ Movies™`,
        datePublished: moviesItem.datePublished,
        dateModified: moviesItem.dateModified,
        articleSection: 'Movies',
        author: {
          '@id': 'https://atozmovies.vercel.app/author/AtoZ Movies™online/'
        },
        publisher: {
          '@id': 'https://gravatar.com/drtrailer2022/#person'
        },
  ...
  return (
    <div>
      <Head>
        ...
        <meta
          property='og:title'
          content={`${moviesItem && moviesItem.name} - AtoZ Movies™`}
        />
        <meta
        ...
        <meta
          name='description'
          content={`${moviesItem.title} available on AtoZ Movies™. Enjoy free streaming of full-length movies and TV series online with no registration required.`}
        />
        <meta
          property='og:url'
