...
const softwareSchema = JSON.stringify({
  ...
  description:
    'Welcome to A to Z Trailers™ – your go-to spot for free online trailers! Watch and enjoy HD streaming, and catch the latest tvshows. Dive into cinema with A to Z Trailers™!',
...
const trailersPage1 = ({ items }) => {
  ...
  return (
    <div className='w-full' style={{ backgroundColor: '#D3D3D3' }}>
      <Head>
        <title> Watch Online Trailers | A to Z Trailers™</title>
        ...
        <meta property='og:title' content=' Watch Online Trailers | A to Z Trailers' />
        <meta
        ...
        <meta
          name='keywords'
          content='aztrailers, a to z trailers, a-z trailers, az trailers, watch free trailers, watch trailers online, download trailers, watch full trailers, watch hd trailers'
        />
        <meta
          property='og:image'
          content='https://azmovies.vercel.app/og_image.jpg'
      ...
      <Script src='../../propler/ads2.js' defer />
        ...
        >
          A to Z Trailers trailers Section.
        </h1>
      ...
      >
        <span className='px-0 bg-gradient-to-r from-amber-500 to-pink-500 bg-clip-text text-transparent text-3xl hover:text-blue-800 font-bold mt-2'>
          For Request or Demand trailers Join Telegram
      ...
      <div className='container'>
        {/* <h1  className='px-0 font-black bg-gradient-to-r from-amber-500 to-pink-500 bg-clip-text text-transparent'>trailers Section</h1> */}
        <div className='flex-container'>
          <div className='main-content'>
            <div className='card-container'>
              {trailersp1Data.map(item => (
                <div key={item.id}>
                  {/* <div key={item.id} className='card'> */}
                  <Link href={`/trailers-page1/${item.id}`}>
...
export async function getStaticProps () {
  try {
    const res = await fetch('https://azmovies.vercel.app/trailersp1.json')
