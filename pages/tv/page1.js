...
const softwareSchema = JSON.stringify({
  ...
  headline: 'Watch Tv Show Page 1 | AtoZ ™',
  ...
  mainEntityOfPage: {
    '@type': 'WebPage',
    '@id': 'https://atozmovies.vercel.app/tv/pge1'
  },
  additionalProperty: {
    '@type': 'PropertyValue',
...
const Page1 = ({ items }) => {
  ...
  return (
    <div className='w-full' style={{ backgroundColor: '#D3D3D3' }}>
      <Head>
        <title> Watch Tv Show Page 1 | AtoZ ™</title>
        ...
        <meta property='og:title' content=' Watch Tv Show Page 1 | AtoZ ™' />
        <meta
