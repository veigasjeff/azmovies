...
const page1 = ({ items }) => {
  ...
  const softwareSchema = JSON.stringify({
    '@context': 'https://schema.org',
    '@type': 'Article',
    '@id': 'https://atozmovies.vercel.app/tv/page1',
    headline: 'Page 1 | Justwatch™',
    url: 'https://atozmovies.vercel.app/tv/page1',
    description:
  ...
  const breadcrumbSchema = JSON.stringify({
    ...
    itemListElement: [
      ...
      },
      {
        ...
        position: 2,
        name: 'movies',
        item: 'https://atozmovies.vercel.app/tv/page1'
      }
    ]
  })
  ...
  return (
    <div className='w-full' style={{ backgroundColor: '#000' }}>
      <Head>
        <title> Page 1 | Justwatch™</title>
        <link rel='canonical' href='https://atozmovies.vercel.app/tv/page1' />
        <meta
          name='robots'
        ...
        <meta property='og:title' content=' Page 1 | Justwatch™' />
        <meta
        ...
        <meta property='og:url' content='https://atozmovies.vercel.app/tv/page1' />
...
export async function getStaticProps() {
  try {
    const res = await fetch('https://atozmovies.vercel.app/tvshowp3.json');
