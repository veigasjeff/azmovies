...
import moviesData from '../../public/tvshowp4.json'
...
const softwareSchema = JSON.stringify({
  ...
  headline: 'Watch Tv Show Page 2 | AtoZ™',
  ...
  mainEntityOfPage: {
    '@type': 'WebPage',
    '@id': 'https://atozmovies.vercel.app/tv/pge2'
  },
  additionalProperty: {
    '@type': 'PropertyValue',
...
const Page2 = ({ items }) => {
  ...
  return (
    <div className='w-full' style={{ backgroundColor: '#D3D3D3' }}>
      <Head>
        <title>Watch Tv Show Page 2 | AtoZ™</title>
        ...
        <meta property='og:title' content=' Watch Tv Show Page 2 | AtoZ™' />
        <meta
        ...
        <meta
          property='og:url'
          content='https://atozmovies.vercel.app/tv/page2'
        />
