...
import tvshowsData from '../../../public/tvshowfull.json'
  ...
  const fetchData = async () => {
    try {
      const response = await fetch(
        'https://atozmovies.vercel.app/tvshowfull.json'
      )
  ...
  const rankMathSchema = JSON.stringify({
    ...
    '@graph': [
      ...
      },
      {
        ...
        headline: `${tvshow.name} | AtoZ Movies™`,
        datePublished: tvshow.datePublished,
        dateModified: tvshow.dateModified,
        articleSection: 'tvshows',
        author: {
          '@id': 'https://gravatar.com/drtrailer2022/'
        },
        publisher: {
        ...
        {isTVShow && (
          <>
            ...
            <p className='text-lg bg-gradient-to-r from-pink-700 to-blue-700 bg-clip-text text-transparent mt-4'>
              ...
              navigation, <strong>AtoZ </strong> provides everything you need to
              enjoy <strong>{tvshow.title}</strong>
            ...
            <p className='text-lg bg-gradient-to-r from-pink-700 to-blue-700 bg-clip-text text-transparent mt-4'>
              ...
              <strong>{tvshow.title}</strong> on <strong>AtoZ </strong> is your
              go-to destination for streaming TV series online. Join our
              community of viewers and start watching{' '}
              <strong>{tvshow.title}</strong> today. With <strong>AtoZ </strong>
        ...
        {isAdult && (
          <>
            ...
            <p className='text-lg bg-gradient-to-r from-pink-700 to-blue-700 bg-clip-text text-transparent mt-4'>
              ...
              <strong>{tvshow.title}</strong>. At <strong>AtoZ </strong>, we
            ...
            <p className='text-lg bg-gradient-to-r from-pink-700 to-blue-700 bg-clip-text text-transparent mt-4'>
              ...
              updated, giving you access to new releases as soon as they become
              available. Whether you're exploring new genres or returning to
              your favorites, <strong>{tvshow.title}</strong>
              and other top titles are available at your fingertips.
            </p>
            <p className='text-lg bg-gradient-to-r from-pink-700 to-blue-700 bg-clip-text text-transparent mt-4'>
              For a premium experience in adult entertainment, look no further
              than <strong>{tvshow.title}</strong> on <strong>AtoZ </strong>.
              Our platform ensures your privacy and security while you enjoy the
              content you love. Start streaming <strong>{tvshow.title}</strong>{' '}
        ...
        {!isTVShow && !isAdult && (
          <>
            ...
            <p className='text-lg bg-gradient-to-r from-pink-700 to-blue-700 bg-clip-text text-transparent mt-4'>
              ...
              of tvshows and TV shows, including the latest blockbusters like{' '}
              <strong>{tvshow.title}</strong>. Whether you're a fan of action,
            ...
            <p className='text-lg bg-gradient-to-r from-pink-700 to-blue-700 bg-clip-text text-transparent mt-4'>
              ...
              platform is designed to make it easy for you to discover and enjoy
              your favorite films. With regularly updated content, you will
              always have access to the newest releases, ensuring you can watch{' '}
              <strong>{tvshow.title}</strong> and other top titles as soon as
              they're available.
            </p>
            <p className='text-lg bg-gradient-to-r from-pink-700 to-blue-700 bg-clip-text text-transparent mt-4'>
              Whether you're revisiting a classic or catching a new release,{' '}
              <strong>{tvshow.title}</strong> on <strong>AtoZ </strong> is the
              perfect way to enjoy your tvshow night. Join the countless users
                  ...
                  <div className={styles.iframeWrapper}>
                    <div className={styles.iframeContainer}>
                      <iframe
                        ...
                        frameBorder='0'
                        src={`https://geo.dailymotion.com/player/xjrxe.html?video=${tvshow.traileritem}&mute=true&Autoquality=1080p`}
                        allowFullScreen
