...
<SocialSharing title={movie.name} />
     ...
     {!isTVShow && !isAdult && (
        <>
          ...
          <p className={styles.year}style={{ textShadow: '1px 1px 0px #000' }}>
            ...
            need to enjoy <strong>{movie.title}</strong> and other top TV series. Our library is frequently updated, so you can always find the latest episodes as soon as they air.
          </p>
          <p className={styles.year}style={{ textShadow: '1px 1px 0px #000' }}>
...
{/* Buttons - Display only if it's a TV show */}
  ...
  <div className="relative z-10 mt-4 space-y-4">
        <button
          ...
          style={{ textShadow: '1px 1px 0px #000', fontWeight: 'bold', fontSize: '1.5rem'  }}>     
            Next Episode
        </button>
      </div>
...
{/* Previous Episode Button - Display only if it's a TV show */}
    ...
    <button
        ...
        <p className={styles.episode}    style={{ marginTop:'10px', textShadow: '1px 1px 0px #000', fontWeight: 'bold', fontSize: '1.5rem'  }}> <strong>Total Of Episodes:</strong> {movie.episode}</p>
