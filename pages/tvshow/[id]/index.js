...
import moviesData from '../../../public/tvshowfull.json'
        ...
        {isTVShow && (
          <>
            ...
            <p className='text-lg bg-gradient-to-r from-pink-700 to-blue-700 bg-clip-text text-transparent mt-4'>
              ...
              enjoy <strong>{moviesp1Item.title}</strong>
            ...
            <p className='text-lg bg-gradient-to-r from-pink-700 to-blue-700 bg-clip-text text-transparent mt-4'>
              ...
              <strong>{moviesp1Item.title}</strong> today. With{' '}
              <strong>AtoZ </strong>, your favorite TV series is just a click
              away.
            </p>
          </>
        )}
        ...
        {isAdult && (
          <>
            ...
            <p className='text-lg bg-gradient-to-r from-pink-700 to-blue-700 bg-clip-text text-transparent mt-4'>
              ...
              <strong>AtoZ </strong> is the trusted choice for adult content.
            </p>
          </>
        )}
        ...
        {!isTVShow && !isAdult && (
          <>
            ...
            <p className='text-lg bg-gradient-to-r from-pink-700 to-blue-700 bg-clip-text text-transparent mt-4'>
              ...
              countless users who trust us for their streaming needs and start
              watching <strong>{moviesp1Item.title}</strong> online today. At{' '}
