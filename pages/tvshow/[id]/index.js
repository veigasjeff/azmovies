  ...
  const rankMathSchema = JSON.stringify({
    ...
    '@graph': [
      ...
      },
      {
        ...
        headline: ` ${tvshowzipItem.name} | AtoZ™`,
        datePublished: tvshowzipItem.datePublished,
        dateModified: tvshowzipItem.dateModified,
  ...
  return (
    <div>
      <Head>
        ...
        />
        <title> {tvshowzipItem.name} | AtoZ™</title>
        ...
        <meta
          property='og:title'
          content={`${tvshowzipItem && tvshowzipItem.name} - AtoZ™`}
        />
        <meta
          property='og:description'
          content='Stream HD tvshowzipItems and TV series for free on AtoZ™. Online. Stream. Download. full-length tvshowzipItems and shows in HD quality without registration.'
        />
        <meta
          name='description'
          content={`${tvshowzipItem.title} available on AtoZ™. Enjoy free streaming of full-length tvshowzipItems and TV series online with no registration required.`}
        />
        <meta
          property='og:url'
