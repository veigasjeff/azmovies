...
const softwareSchema = JSON.stringify({
  ...
  headline: 'AZtvshow™ - Explore. Discover. Watch.',
  url: 'https://azmovies.vercel.app/tvshow/',
  description:
    'Welcome to AZ tvshow™ where you watch the best tvshow from A to Z for free online. Your online source to download and watch free online tvshow, the latest movie trailers, hd streaming tvshow, find theater movie times and more at AZ tvshow™.',
  image: 'https://azmovies.vercel.app/wp-content/uploads/tvshow.webp',
  author: {
    '@type': 'Person',
    name: 'DrTrailer',
...
const breadcrumbSchema = JSON.stringify({
  ...
  itemListElement: [
    ...
    },
    {
      ...
      position: 2,
      name: 'tvshow.',
      item: 'https://azmovies.vercel.app/tvshow/'
    }
  ]
})
...
const tvshowPage = ({ items }) => {
  ...
  return (
    <div className='w-full' style={{ backgroundColor: '#D3D3D3' }}>
      <Head>
        <title> AZ Tv Show™ - Tv Show Section.</title>
        <link
          rel='canonical'
          href='https://azmovies.vercel.app/tvshow/'
        />
        <meta
          name='robots'
        ...
        <meta
          property='og:title'
          content='  AZtvshow™ - Explore. Discover. Watch.'
        />
        <meta
        ...
        <meta
          property='og:url'
          content='https://azmovies.vercel.app/tvshow'
        />
