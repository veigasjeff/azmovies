...
const breadcrumbSchema = JSON.stringify({
  ...
  itemListElement: [
    ...
    },
    {
      ...
      position: 2,
      name: 'Tv Sshow',
      item: 'https://atozmovies.vercel.app/tvshow'
    }
  ]
})
...
const moviesPage = ({ items }) => {
  ...
  return (
    <div className='w-full' style={{ backgroundColor: '#D3D3D3' }}>
      <Head>
        <title> Watch Tv Show | AtoZ ™</title>
        ...
        <meta property='og:title' content=' Watch Tv Show | AtoZ ™' />
        <meta
        ...
        <meta property='og:url' content='https://atozmovies.vercel.app/tvshow' />
