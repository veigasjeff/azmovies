...
const uwatchfreeSchema = JSON.stringify([
  {
    ...
    '@type': 'Organization',
    name: 'AZ Tvshow™ - Explore. Discover. Download.',
...
const softwareSchema = JSON.stringify({
  ...
  headline: 'Watch Online Tvshow | AZ Tvshow™',
  url: 'https://azmovies.vercel.app/tvshow/',
  description:
    'Welcome to AZ Tvshow™ – your go-to spot for free online tvshow! Watch and enjoy HD streaming, and catch the latest tvshows. Dive into cinema with AZ Tvshow™!',
...
const tvshowPage = ({ items }) => {
  ...
  return (
    <div className='w-full' style={{ backgroundColor: '#D3D3D3' }}>
      <Head>
        <title> Watch Onile Tvshow | AZ Tvshow™</title>
        ...
        <meta property='og:title' content=' Watch Tvshow |  AZ Tvshow™' />
        <meta
        ...
        <meta
          name='keywords'
          content='az tvshow, AZ tvshow, a-z tvshow, az tvshow, watch free tvshow, watch tvshow online, download tvshow, watch full tvshow, watch hd tvshow'
        />
        <meta
          property='og:image'
          content='https://azmovies.vercel.app/og_image.jpg'
