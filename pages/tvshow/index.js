...
const tvshowPage = ({ items }) => {
  ...
  useEffect(() => {
    async function fetchData () {
      try {
        const [ tvshowRes] = await Promise.all(
          [
  ...
  return (
    <div className='w-full' style={{ backgroundColor: '#D3D3D3' }}>
      <Head>
        ...
        <meta property='og:title' content=' Watch Tvshow |  A to Z Tvshow™' />
        <meta
        ...
        <meta
          name='keywords'
          content='az tvshow, A to Z tvshow, a-z tvshow, az tvshow, watch free tvshow, watch tvshow online, download tvshow, watch full tvshow, watch hd tvshow'
        />
        <meta
          property='og:image'
          content='https://azmovies.vercel.app/og_image.jpg'
