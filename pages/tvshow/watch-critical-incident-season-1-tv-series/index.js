...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    name: 'Watch Movie Critical Incident Season 1 (2024) | AtoZ Movies™',
    alternateName: [
      'Ver película Critical Incident Season 1 (2024) | AtoZ Movies™',
      'Regarder le film Critical Incident Season 1 (2024) | AtoZ Movies™',
      'Film Critical Incident Season 1 (2024) ansehen | AtoZ Movies™',
      '观看电影 Critical Incident Season 1 (2024) | AtoZ Movies™',
      '映画 Critical Incident Season 1 (2024) を見る | AtoZ Movies™',
      '영화 Critical Incident Season 1 (2024) 보기 | AtoZ Movies™',
      'Assistir Filme Critical Incident Season 1 (2024) | AtoZ Movies™',
      'Guarda il film Critical Incident Season 1 (2024) | AtoZ Movies™',
      'Посмотреть фильм Critical Incident Season 1 (2024) | AtoZ Movies™',
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie Critical Incident Season 1 (2024) | AtoZ Movies™</title>
...
export async function getServerSideProps () {
  const res = await fetch('https://atozmovies.vercel.app/moviesp9.json')
