...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    name: 'Watch Movie Dark Matter Season 1 (2024) | AtoZ Movies™',
    alternateName: [
      'Ver película Dark Matter Season 1 (2024) | AtoZ Movies™',
      'Regarder le film Dark Matter Season 1 (2024) | AtoZ Movies™',
      'Film Dark Matter Season 1 (2024) ansehen | AtoZ Movies™',
      '观看电影 Dark Matter Season 1 (2024) | AtoZ Movies™',
      '映画 Dark Matter Season 1 (2024) を見る | AtoZ Movies™',
      '영화 Dark Matter Season 1 (2024) 보기 | AtoZ Movies™',
      'Assistir Filme Dark Matter Season 1 (2024) | AtoZ Movies™',
      'Guarda il film Dark Matter Season 1 (2024) | AtoZ Movies™',
      'Посмотреть фильм Dark Matter Season 1 (2024) | AtoZ Movies™',
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie Dark Matter Season 1 (2024) | AtoZ Movies™</title>
