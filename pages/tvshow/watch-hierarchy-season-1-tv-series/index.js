...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    name: 'Watch Movie Hierarchy Season 1 (2024) | AtoZ Movies™',
    alternateName: [
      'Ver película Hierarchy Season 1 (2024) | AtoZ Movies™',
      'Regarder le film Hierarchy Season 1 (2024) | AtoZ Movies™',
      'Film Hierarchy Season 1 (2024) ansehen | AtoZ Movies™',
      '观看电影 Hierarchy Season 1 (2024) | AtoZ Movies™',
      '映画 Hierarchy Season 1 (2024) を見る | AtoZ Movies™',
      '영화 Hierarchy Season 1 (2024) 보기 | AtoZ Movies™',
      'Assistir Filme Hierarchy Season 1 (2024) | AtoZ Movies™',
      'Guarda il film Hierarchy Season 1 (2024) | AtoZ Movies™',
      'Посмотреть фильм Hierarchy Season 1 (2024) | AtoZ Movies™',
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie Hierarchy Season 1 (2024) | AtoZ Movies™</title>
