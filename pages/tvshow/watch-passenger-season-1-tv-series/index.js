...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    name: 'Watch Movie Passenger Season 1 (2024) | AtoZ Movies™',
    alternateName: [
      'Ver película Passenger Season 1 (2024) | AtoZ Movies™',
      'Regarder le film Passenger Season 1 (2024) | AtoZ Movies™',
      'Film Passenger Season 1 (2024) ansehen | AtoZ Movies™',
      '观看电影 Passenger Season 1 (2024) | AtoZ Movies™',
      '映画 Passenger Season 1 (2024) を見る | AtoZ Movies™',
      '영화 Passenger Season 1 (2024) 보기 | AtoZ Movies™',
      'Assistir Filme Passenger Season 1 (2024) | AtoZ Movies™',
      'Guarda il film Passenger Season 1 (2024) | AtoZ Movies™',
      'Посмотреть фильм Passenger Season 1 (2024) | AtoZ Movies™',
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie Passenger Season 1 (2024) | AtoZ Movies™</title>
