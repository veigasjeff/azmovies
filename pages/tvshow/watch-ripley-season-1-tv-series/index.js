...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    name: 'Watch Movie Ripley Season 1 (2024) | AtoZ Movies™',
    alternateName: [
      'Ver película Ripley Season 1 (2024) | AtoZ Movies™',
      'Regarder le film Ripley Season 1 (2024) | AtoZ Movies™',
      'Film Ripley Season 1 (2024) ansehen | AtoZ Movies™',
      '观看电影 Ripley Season 1 (2024) | AtoZ Movies™',
      '映画 Ripley Season 1 (2024) を見る | AtoZ Movies™',
      '영화 Ripley Season 1 (2024) 보기 | AtoZ Movies™',
      'Assistir Filme Ripley Season 1 (2024) | AtoZ Movies™',
      'Guarda il film Ripley Season 1 (2024) | AtoZ Movies™',
      'Посмотреть фильм Ripley Season 1 (2024) | AtoZ Movies™',
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie Ripley Season 1 (2024) | AtoZ Movies™</title>
