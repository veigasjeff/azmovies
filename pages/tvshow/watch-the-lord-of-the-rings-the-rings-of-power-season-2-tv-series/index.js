  ...
  return (
    <div>
      <Head>
        ...
        />
        <title>Watch Tvshow The Lord of the Rings: The Rings of Power Season 2 (2024) | AtoZ Movies™</title>
...
export async function getServerSideProps () {
  const res = await fetch('http://localhost:3000/moviesp11.json')
  const data = await res.json()
  const selectedMovie = data.find(
    movie => movie.id === 'INDEXP1114'
  )
  return {
    props: {
      movie: selectedMovie
