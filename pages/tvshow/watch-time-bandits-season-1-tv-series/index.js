...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    name: 'Watch Movie Time Bandits Season 1 (2024) | AtoZ Movies™',
    alternateName: [
      'Ver película Time Bandits Season 1 (2024) | AtoZ Movies™',
      'Regarder le film Time Bandits Season 1 (2024) | AtoZ Movies™',
      'Film Time Bandits Season 1 (2024) ansehen | AtoZ Movies™',
      '观看电影 Time Bandits Season 1 (2024) | AtoZ Movies™',
      '映画 Time Bandits Season 1 (2024) を見る | AtoZ Movies™',
      '영화 Time Bandits Season 1 (2024) 보기 | AtoZ Movies™',
      'Assistir Filme Time Bandits Season 1 (2024) | AtoZ Movies™',
      'Guarda il film Time Bandits Season 1 (2024) | AtoZ Movies™',
      'Посмотреть фильм Time Bandits Season 1 (2024) | AtoZ Movies™',
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie Time Bandits Season 1 (2024) | AtoZ Movies™</title>
